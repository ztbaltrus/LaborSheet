...
var webPart = (function () {
    function webPart(webpartContext) {
        this.webpartContext = webpartContext;
    }
    webPart = __decorate([
        __WEBPACK_IMPORTED_MODULE_0_aurelia_framework__["b" /* inject */]
    ], webPart);
    return webPart;
}());
