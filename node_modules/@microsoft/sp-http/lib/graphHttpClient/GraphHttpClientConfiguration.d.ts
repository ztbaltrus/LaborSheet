 ...
 * @beta
 */
export interface IGraphHttpClientConfiguration extends IHttpClientConfiguration {
}
/**
 ...
 * @beta
 */
export default class GraphHttpClientConfiguration extends HttpClientConfiguration implements IGraphHttpClientConfiguration {
 ...
 * @beta
 */
export interface IGraphHttpClientConfigurations {
    /**
...
export declare const predefinedConfigurations: IGraphHttpClientConfigurations;
