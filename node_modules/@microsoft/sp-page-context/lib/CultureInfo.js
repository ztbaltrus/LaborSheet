...
var CultureInfo = (function () {
    ...
    CultureInfo.prototype._validate = function (data) {
        Validate.isNotNullOrUndefined(data, 'ICultureInfoData object');
        Validate.isNotNullOrUndefined(data.currentCultureName, 'currentCultureName');
        Validate.isNotNullOrUndefined(data.currentUICultureName, 'currentUICultureName');
        Validate.isNotNullOrUndefined(data.isRightToLeft, 'isRightToLeft');
    };
    return CultureInfo;
}());
