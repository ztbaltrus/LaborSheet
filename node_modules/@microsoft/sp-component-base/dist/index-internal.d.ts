...
/* Excluded from this release type: _FabricThemeProvider */
...
declare interface ISemanticColors {
    /**
     * The default color for backgrounds.
     */
    bodyBackground: string;
    /**
     * A special semantic slot that will always be the same or darker (not necessarily stronger) than
     * the bodyBackground slot, even in an inverted theme. This is used for zones near the edge of the
     * page, to provide a vignetting effect. This is especially effective with zones near the edge of
     * the page in stronger themes or if it uses a variant theme.
     */
    ...
    /**
     * The default color for disabled text on top of disabledBackground; e.g.
     * text in a disabled text field, disabled button text.
     */
    disabledText: string;
    /**
...
/* Excluded from this release type: _ITheme */

/* Excluded from this release type: _IThemeProvider */

/* Excluded from this release type: _LegacyThirdPartyFabricCoreLoader */

/* Excluded from this release type: _ThemeChangedEventArgs */
