...
var BaseComponentContext = (function () {
    function BaseComponentContext(parameters) {
        ...
        this._graphHttpClient = this.serviceScope.createDefaultAndProvide(GraphHttpClient.serviceKey);
        ...
        this.serviceScope.whenFinished(function () {
            ...
            _this._msGraphClientFactory = new MSGraphClientFactory(_this.serviceScope);
        });
        this._aadClientFactory = new AadHttpClientFactory(this.serviceScope);
        this._aadTokenFactory = new AadTokenProviderFactory();
