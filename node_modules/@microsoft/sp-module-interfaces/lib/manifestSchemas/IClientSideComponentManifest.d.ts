...
export interface IClientSideComponentManifest extends IClientSideManifestBase {
     ...
     * @internal
     *
     * @internalremarks - this property is true when the manifest comes from the debug query param.
     */
    _isDebug?: boolean;
    /**
    ...
    version: string;
    /**
     * Definition: A list of component manifests that must be preloaded alongside this component.
    ...
    /**
     * Definitions: Property bag for the component manifest.
