...
export interface IPreloadOptions {
     ...
     * the Folder property, the preloadListItemQueryOption would look like this
     * "$select=MyField1,MyField2&$expand=Folder"
     * This ucrrently provides a way to override the value of preloadListItemQueryOption
    ...
    /**
     * Definition: This specifies what to fetch from a SharePoint list item Properties property.
     * For example, if you want to inlcude MyProperty1 and MyProperty2 from item Properties property,
     * the preloadListItemProperties would looks like this "[MyProperty1,MyProperty2]".
     * The main reason not to pass "$expand=Properties&select=Properties/MyProperty1,Properties/MyProperty2"
     * to PreloadListItemQueryOption is to avoid multiple exptra sql roundtrips.
     ...
     * https://msdn.microsoft.com/en-us/library/microsoft.sharepoint.splistitem.properties.aspx
     * If the specified name doesn't exist in the item Properties property, it will not return the value.
     * Usage: This specifies what to fetch from a SharePoint list item Properties property
     * Required: no
