...
var multiVersionSchema = require('./manifestSchemas/jsonSchemas/client-side-multi-version-manifest.schema.json');
...
var ManifestValidator = (function () {
    ...
    ManifestValidator.validateMultiVersionManifest = function (manifest // tslint:disable-line:no-any
    ) {
    ...
    ManifestValidator._validateManifest = function (
