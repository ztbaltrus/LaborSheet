...
export declare class InstallManager {
    ...
    doInstall(options: IInstallManagerOptions): Promise<void>;
    /**
     ...
     */
    private _createTempModulesAndCheckShrinkwrap(shrinkwrapFile);
    /**
     * Runs "npm install" in the common folder.
     */
    private _installCommonModules(shrinkwrapIsUpToDate, allowShrinkwrapUpdates);
    private _checkIfReleaseIsPublished();
    private _queryIfReleaseIsPublished(registryUrl);
    /**
     ...
     */
    private _syncFile(sourcePath, targetPath);
    /**
