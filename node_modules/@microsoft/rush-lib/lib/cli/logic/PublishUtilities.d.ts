...
export declare class PublishUtilities {
    ...
    private static _writePackageChanges(change, allChanges, allPackages, rushConfiguration, shouldCommit, prereleaseToken?, projectsToExclude?);
    private static _isCyclicDependency(allPackages, packageName, dependencyName);
    private static _updateDependencies(packageName, dependencies, allChanges, allPackages, rushConfiguration, prereleaseToken, projectsToExclude?);
    /**
     ...
     */
    private static _addChange(change, allChanges, allPackages, rushConfiguration, prereleaseToken?, projectsToExclude?);
    private static _updateDownstreamDependencies(change, allChanges, allPackages, rushConfiguration, prereleaseToken, projectsToExclude?);
    private static _updateDownstreamDependency(parentPackageName, dependencies, change, allChanges, allPackages, rushConfiguration, prereleaseToken, projectsToExclude?);
    private static _updateDependencyVersion(packageName, dependencies, dependencyName, dependencyChange, allChanges, allPackages, rushConfiguration);
}
