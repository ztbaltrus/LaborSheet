...
describe('extractVersionFromPnpmVersionSpecifier', () => {
    it('extracts a simple version with no slashes', () => {
        expect(PnpmShrinkwrapFile_1.extractVersionFromPnpmVersionSpecifier('0.0.5')).toEqual('0.0.5');
    });
    it('extracts an unscoped peer dep', () => {
        expect(PnpmShrinkwrapFile_1.extractVersionFromPnpmVersionSpecifier('/gulp-karma/0.0.5/karma@0.13.22')).toEqual('0.0.5');
    });
    it('extracts a scoped peer dep', () => {
        expect(PnpmShrinkwrapFile_1.extractVersionFromPnpmVersionSpecifier('/@ms/sp-client-utilities/3.1.1/foo@13.1.0')).toEqual('3.1.1');
    });
    it('extracts relative versions', () => {
        expect(PnpmShrinkwrapFile_1.extractVersionFromPnpmVersionSpecifier('example.pkgs.visualstudio.com/@scope/testDep/1.0.0'))
            .toEqual('1.0.0');
        expect(PnpmShrinkwrapFile_1.extractVersionFromPnpmVersionSpecifier('example.pkgs.visualstudio.com/@scope/testDep/1.2.3-beta.3'))
            .toEqual('1.2.3-beta.3');
    });
    it('handles bad cases', () => {
        expect(PnpmShrinkwrapFile_1.extractVersionFromPnpmVersionSpecifier('/foo/gulp-karma/0.0.5/karma@0.13.22')).toEqual(undefined);
        expect(PnpmShrinkwrapFile_1.extractVersionFromPnpmVersionSpecifier('/@ms/3.1.1/foo@13.1.0')).toEqual(undefined);
        expect(PnpmShrinkwrapFile_1.extractVersionFromPnpmVersionSpecifier('')).toEqual(undefined);
        expect(PnpmShrinkwrapFile_1.extractVersionFromPnpmVersionSpecifier('/')).toEqual(undefined);
        expect(PnpmShrinkwrapFile_1.extractVersionFromPnpmVersionSpecifier('//')).toEqual(undefined);
        expect(PnpmShrinkwrapFile_1.extractVersionFromPnpmVersionSpecifier('/@/')).toEqual(undefined);
        expect(PnpmShrinkwrapFile_1.extractVersionFromPnpmVersionSpecifier('example.pkgs.visualstudio.com/@scope/testDep/')).toEqual(undefined);
    });
});
