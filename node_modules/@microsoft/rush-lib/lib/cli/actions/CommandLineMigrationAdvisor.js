...
class CommandLineMigrationAdvisor {
    ...
    static _reportDeprecated(message) {
        const wrap = wordwrap.soft(Utilities_1.Utilities.getConsoleWidth());
        console.error(colors.red(wrap('ERROR: You specified an outdated command-line that is no longer supported by this version of Rush:')));
