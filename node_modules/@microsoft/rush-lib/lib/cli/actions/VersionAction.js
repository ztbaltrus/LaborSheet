...
class VersionAction extends BaseRushAction_1.BaseRushAction {
    ...
    _validateResult() {
        ...
        const mismatchFinder = new VersionMismatchFinder_1.VersionMismatchFinder(rushConfig.projects, rushConfig.commonVersions.allowedAlternativeVersions);
    ...
    _getUserEmail() {
        return Utilities_1.Utilities.executeCommandAndCaptureOutput('git', ['config', 'user.email'], '.').trim();
    }
