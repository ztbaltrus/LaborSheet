...
import { Dialog, DialogType, DialogFooter, Button, Link } from '@microsoft/office-ui-fabric-react-bundle';
...
var SerializedCanvasView = (function (_super) {
    ...
    SerializedCanvasView.prototype.render = function () {
        ...
        return (React.createElement(Dialog, { isOpen: this.props.isVisible, type: DialogType.normal, onDismiss: this.props.closeCallback, title: strings.WebPartData, isBlocking: false, containerClassName: styles.container, contentClassName: styles.content },
            React.createElement("div", null,
                ...
                React.createElement(Link, tslib_1.__assign({ className: styles.learnMoreLink }, {
                    ...
                    target: '_blank'
                } ), strings.WebPartDataHelpInfoLink)),
