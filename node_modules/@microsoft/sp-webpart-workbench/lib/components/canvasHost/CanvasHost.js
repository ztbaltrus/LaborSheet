...
import propertyPaneStyles from '@microsoft/sp-webpart-base/lib/propertyPane/propertyPaneController/PropertyPaneController.module.scss';
    ...
    CanvasHost.prototype.componentDidMount = function () {
        ...
        this._canvasPromise =
            Canvas.instantiateCanvas(this._canvasElement, canvasOptions).then(function (canvas) {
                ...
                if (canvasOptions.mode === DisplayMode.Edit) {
