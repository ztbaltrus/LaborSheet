...
export default class EngagementLogger {
    ...
    */
    ...
    private static _logEngagementData(engagementData, isLogEntry?);
    private static _checkValidTagName(engagementData, isLogEntry?);
    private static _addContextData(data);
}
