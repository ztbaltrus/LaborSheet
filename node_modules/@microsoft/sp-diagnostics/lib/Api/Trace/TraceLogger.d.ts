...
export default class TraceLogger {
    ...
    **/
    ...
    private static _log(source, data, eventName, isError, resultCode?, serviceScope?);
    private static _addEventPrefix(source, eventName?);
    private static _writeToConsole(logEvent, isError, resultCode?);
}
