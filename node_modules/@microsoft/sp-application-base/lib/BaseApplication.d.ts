...
export default class BaseApplication extends BaseComponent {
    ...
    /**
     * This lifecycle event occurs before hiding the application chrome. At this point the applicaiton still has
    ...
    /**
     * Allows the navigator to reinitial SPFx components with _IPreloadedData.
     *
     * @remarks
     * This will be removed soon. Please use navigator from application context
     * to invoke public APIs
    ...
    /**
     * This is a handler to update Suite Nav contaier height, when sp-suite-nav wants to update it.
     *
     * @param height - Height of the suite nav bar container to be set.
     */
    private _suiteNavHeightHandler(height);
}
