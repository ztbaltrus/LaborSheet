...
import { Guid, UrlQueryParameterCollection, Validate, _SPEventManager, _SPKillSwitch } from '@microsoft/sp-core-library';
...
var BaseApplication = (function (_super) {
    ...
    BaseApplication.prototype._render = function () {
        ...
        try {
            ...
            var suiteNavManager = new SuiteNavManager(this.context.chrome.suiteNavDiv, this.context.serviceScope);
