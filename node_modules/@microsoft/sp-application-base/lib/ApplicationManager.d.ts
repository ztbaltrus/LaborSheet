...
export default class ApplicationManager {
    ...
    private _initializeApplicationWithTelemetry<TApplication>(application, applicationId, pageChrome, qosMonitor, error);
    /**
     ...
     */
    private _loadApplicationComponent<TApplication>(applicationId, error);
    private _isChromelessApplication(applicationId);
    /**
     ...
     * @returns A promise
     */
    private _initializeApplication(application, applicationId, pageChrome);
}
