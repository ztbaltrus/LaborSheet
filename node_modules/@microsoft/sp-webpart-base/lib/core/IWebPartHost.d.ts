...
export default interface IWebPartHost {
    ...
    /**
     * API for the webpart to set the minimum height of it's container element.
     */
    setElementMinHeight?: (minHeight: number) => void;
}
/**
...
export interface IPropertyPaneLifeCycleEventCallback {
    (event: PropertyPaneLifeCycleEvent, data?: IWebPartData): void;
}
