...
export interface IWebPartPropertyMetadata {
     ...
     * Web part should use this property to declare dynamic runtime component dependencies, which are required only for
     * specific state of the property. Framework will ensure this component is preloaded for web part.
     *
     * E.g. User can select one of the multiple Layouts available for the web part during edit mode. This will optimize
     * web part bundle not to embed code for all layout code but fraemwork will load required layout selectively at
     * runtime.
     *
     * @alpha
     */
     ...
     *
     * @internalremarks: We should find a way to associate type to this object before this API becomes available to 3rd
     ...
     *  feature available to 3rd parties.
