 ...
 *
 * @param field - Group field reference.
 */
export declare function getFixedUpPropValue(field: IPropertyPaneField<any>, properties: any, dynamicConfiguration: IDynamicConfiguration): any;
/**
 ...
 * @param callback - callback supplied by the web part for the dynamic field.
 */
export declare function getFixedUpDynamicProperty(dynamicConfiguration: IDynamicConfiguration, propValue: any, callback?: () => void): DynamicProperty<any>;
