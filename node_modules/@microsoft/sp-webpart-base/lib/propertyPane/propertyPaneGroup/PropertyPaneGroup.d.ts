...
export default class PropertyPaneGroup extends React.Component<IPropertyPaneGroupProps, IPropertyPaneGroupState> {
     ...
     */
    private _getDynamicProperty(value, groupField);
    private _onFocusTextFieldPropertyPane(ev, props);
    private _onBlurTextFieldPropertyPane(ev, props);
    /**
  ...
  * @params {IChoiceGroupOption} checkedOption: the option representing the field which is checked now.
    ...
    private _onDynamicDataWidgetApplyClick(groupField, targetProperty, newPropValue);
}
