...
export default class PropertyPaneController {
    /**
     * The service key for PropertyPaneController.
     */
    static readonly serviceKey: ServiceKey<PropertyPaneController>;
    /**
    ...
    private _consumers;
    /**
     * Returns an instance of the PropertyPaneController.
     *
     * This method is a callback sent to the ServiceScope, and only service scope can create
     * instance of PropertyPaneController.
     *
     * This method is added is because, the class constructor needs to be private. This is to
     * ensure that, only service scope will be able to create the instance of this class.
     *
     * @param serviceScope - ServiceScope instance.
     */
    private static _create(serviceScope);
    /**
     ...
     *
     * @param getConsumer - delegate to get the property pane consumer instance.
     * @param callback - callback to be called when a configuration event happens.
     */
    constructor(getConsumer?: (id: string) => IPropertyPaneConsumer, callback?: ILifeCycleEventCallback);
    /**
     ...
     */
    private _executeAction(toBeConfiguredConsumer, toBeConfiguredConsumerInstanceId, propertyPaneAction);
    /**
     ...
     */
    private _renderPropertyPane(currentConsumer, recreatePropertyPane?, reset?);
    /**
     ...
     * @param reset - Indicating whether property pane state should be reset or not.
     */
    private _buildAndLoadPropertyPane(propertyPaneData, reset?);
    /**
     ...
     */
    private _loadPropertyPaneComponent(recreatePropertyPane);
    /**
     ...
     */
    private _fireConfigurationEvent(componentId, configurationEvent);
    /**
