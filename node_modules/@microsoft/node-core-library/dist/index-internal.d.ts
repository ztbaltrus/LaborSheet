...
export declare class Executable {
    ...
    private static _tryResolve(filename, options, context);
    private static _tryResolveFileExtension(resolvedPath, context);
    /**
