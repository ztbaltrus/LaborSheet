...
class SPBuildRig extends BuildRig_1.BuildRig {
     ...
     */
    getCoreBuildTask() {
        return coreBuild.parallel(gulp_core_build_typescript_1.tslintCmd, coreBuild.serial(coreBuild.serial(gulp_core_build_typescript_1.tscCmd, gulp_core_build_typescript_1.removeTripleSlash, gulp_core_build_typescript_1.apiExtractorStandalone), coreBuild.serial(...this._postTypescriptTasks)));
    }
    setupSharedConfig() {
        exports.preCopy.name = 'pre-copy';
        exports.postCopy.name = 'post-copy';
        gulp_core_build_typescript_1.apiExtractorStandalone.mergeConfig({
