...
class Markup {
    ...
    static createApiLink(textElements, target) {
        ...
        node_core_library_1.PackageName.combineParts(target.scopeName, target.packageName);
        return {
            kind: 'api-link',
     ...
     */
    static formatApiItemReference(apiItemReference) {
        // Example: "SomeClass"
        let result = apiItemReference.exportName;
