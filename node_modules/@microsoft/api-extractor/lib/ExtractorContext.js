...
class ExtractorContext {
    constructor(options) {
        ...
        const folder = this.packageJsonLookup.tryGetPackageFolderFor(options.entryPointFile);
        if (!folder) {
        ...
        this.parsedPackageName = node_core_library_1.PackageName.parse(this.packageJson.name);
        this.docItemLoader = new DocItemLoader_1.DocItemLoader(this._packageFolder);
        ...
        this.package = new AstPackage_1.AstPackage(this, rootFile); // construct members
    ...
    loadExternalPackages(externalJsonCollectionPath) {
        ...
        node_core_library_1.FileSystem.readFolder(externalJsonCollectionPath, {
            absolutePaths: true
        }).forEach(file => {
