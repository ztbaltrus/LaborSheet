 ...
 * @public
 */
class ApiFileGenerator extends AstItemVisitor_1.AstItemVisitor {
    constructor() {
        super(...arguments);
        this._indentedWriter = new IndentedWriter_1.IndentedWriter();
    }
    /**
    ...
    writeApiFile(reportFilename, context) {
        ...
        node_core_library_1.FileSystem.writeFile(reportFilename, fileContent);
    }
    generateApiFileContent(context) {
        this._insideTypeLiteral = 0;
        // Normalize to CRLF
        this.visit(context.package);
        const fileContent = node_core_library_1.Text.convertToCrLf(this._indentedWriter.toString());
        return fileContent;
    }
    ...
    _writeAedocSynopsis(astItem) {
        ...
        const lines = [];
        if (astItem instanceof AstPackage_1.AstPackage && !astItem.documentation.summary.length) {
...
exports.ApiFileGenerator = ApiFileGenerator;
