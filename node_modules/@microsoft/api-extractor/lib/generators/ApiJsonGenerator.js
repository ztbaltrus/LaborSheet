 ...
 * @public
 */
class ApiJsonGenerator extends AstItemVisitor_1.AstItemVisitor {
    constructor() {
        super(...arguments);
        this.jsonOutput = {};
    }
    writeJsonFile(reportFilename, context) {
        ...
        node_core_library_1.JsonFile.save(this.jsonOutput, reportFilename, { ensureFolderExists: true });
    ...
    visitAstStructuredType(astStructuredType, refObject) {
        ...
        if (astStructuredType.kind === AstItem_1.AstItemKind.Class || astStructuredType.kind === AstItem_1.AstItemKind.Interface) {
            // tslint:disable-next-line:no-any
            structureNode.isSealed = !!astStructuredType.documentation.isSealed;
        }
...
exports.ApiJsonGenerator = ApiJsonGenerator;
