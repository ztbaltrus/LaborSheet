...
class ApiDocumentation {
    constructor(originalAedoc, referenceResolver, context, errorLogger, warnings) {
    ...
    _parseDocs() {
        ...
        const tokenizer = new Tokenizer_1.Tokenizer(this.originalAedoc, this.reportError);
        this.summary = DocElementParser_1.DocElementParser.parseAndNormalize(this, tokenizer);
            ...
            if (token.type === Token_1.TokenType.BlockTag) {
                switch (token.tag) {
                    case '@remarks':
                        ...
                        this.remarks = DocElementParser_1.DocElementParser.parseAndNormalize(this, tokenizer);
                        break;
                    case '@returns':
                        tokenizer.getToken();
                        this._checkInheritDocStatus(token.tag);
                        this.returnsMessage = DocElementParser_1.DocElementParser.parseAndNormalize(this, tokenizer);
                        break;
                    case '@param':
                        tokenizer.getToken();
                        this._checkInheritDocStatus(token.tag);
                    ...
                    case '@deprecated':
                        tokenizer.getToken();
                        this.deprecatedMessage = DocElementParser_1.DocElementParser.parseAndNormalize(this, tokenizer);
                    ...
                    case '@internalremarks':
                        // parse but discard
                        tokenizer.getToken();
                        DocElementParser_1.DocElementParser.parse(this, tokenizer);
                        break;
                    case '@public':
                        tokenizer.getToken();
    ...
    _parseParam(tokenizer) {
        ...
        if (hyphenIndex < 0) {
            ...
            const remainingElements = DocElementParser_1.DocElementParser.parse(this, tokenizer);
    ...
    _completeInheritdocs(warnings) {
        for (;;) {
            ...
            DocElementParser_1.DocElementParser.parseInheritDoc(this, token, warnings);
        }
    }
