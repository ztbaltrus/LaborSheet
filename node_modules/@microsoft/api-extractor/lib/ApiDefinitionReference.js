...
class ApiDefinitionReference {
     ...
     */
    static createFromString(apiReferenceExpr, reportError) {
        ...
        let parts = apiReferenceExpr.match(ApiDefinitionReference._packageRegEx);
        if (parts) {
            // parts[1] is of the form ‘@microsoft/sp-core-library’ or ‘sp-core-library’
            const parsedPackageName = node_core_library_1.PackageName.parse(parts[1]);
