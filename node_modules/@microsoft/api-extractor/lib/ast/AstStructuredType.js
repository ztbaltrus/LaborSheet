...
/**
  ...
  */
class AstStructuredType extends AstItemContainer_1.AstItemContainer {
    constructor(options) {
        super(options);
        ...
        for (const memberDeclaration of this._classLikeDeclaration.members || []) {
            ...
            if (memberSymbol) {
                ...
                if (memberDeclaration.kind !== ts.SyntaxKind.SemicolonClassElement) {
                    ...
                    this.reportWarning(PrettyPrinter_1.PrettyPrinter.formatFileAndLineNumber(memberDeclaration)
        ...
        for (const member of this.getSortedMemberItems()) {
            const memberSymbol = TypeScriptHelpers_1.TypeScriptHelpers.getSymbolForDeclaration(member.getDeclaration());
    ...
    _processMember(memberSymbol, memberDeclaration) {
        ...
        if (memberSymbol.flags & (ts.SymbolFlags.Method |
            ...
            this.addMemberItem(new AstMethod_1.AstMethod(memberOptions));
        }
        else if (memberSymbol.flags & (ts.SymbolFlags.Property |
            ts.SymbolFlags.GetAccessor)) {
            this.addMemberItem(new AstProperty_1.AstProperty(memberOptions));
        }
        else {
...
exports.AstStructuredType = AstStructuredType;
