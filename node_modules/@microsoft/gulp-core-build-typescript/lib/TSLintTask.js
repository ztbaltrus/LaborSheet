...
class TSLintTask extends gulp_core_build_1.GulpTask {
    ...
    executeTask(gulp, completeCallback) {
        ...
        node_core_library_1.JsonFile.save(lintRulesFile, this._getTsLintFilepath(), { ensureFolderExists: true });
        ...
        try {
            ...
            node_core_library_1.JsonFile.save(tsconfigFileData, tsconfigFilePath, { ensureFolderExists: true });
