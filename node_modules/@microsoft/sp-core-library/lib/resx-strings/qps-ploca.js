define([], function() {
  var strings = {
    "_gIErrcTokcw+/VVwa+ReIA": {
      ...
      "isEmptyStringValidateError": "***Ŧħę vǻľűĕ ƒőř \"{0}\" mŭśť ŉŏţ ƀȇ ąņ ēmƿťȳ şťŕīŉġ",
      "isDisposedValidateError": "***Ŧħȇ \"{0}\" ōƃĴėćŧ ĉàŋŉơţ ƀē ųśȅđ ƃȇčàůśę įŧ ħąş ƀȅęň đıśƿơšēď.",
      "invalidVersionStringError": "***Ĭņvăľįđ vĕŕŝīơŉ šŧŕĩņġ: \"{0}\"",
      ...
      "serviceScopeAlreadyFinishedError": "***Ťħȅ ŠȇŕvĩċȇŞĉơƥė įş āľŕēȃđȳ ƒıŉıŝħĕď",
