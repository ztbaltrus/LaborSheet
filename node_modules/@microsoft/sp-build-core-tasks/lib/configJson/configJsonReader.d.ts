...
export declare function readConfigFile(logVerbose: (message: string) => void, filename?: string): IConfigJsonResult;
export declare function readV1ConfigFile(logVerbose: (message: string) => void, filename?: string): IV1ConfigJsonResult;
