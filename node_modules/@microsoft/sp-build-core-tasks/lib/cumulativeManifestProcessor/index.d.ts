...
export default class CumulativeManifestProcessor {
    ...
    static initializeFromGulpTask(parentTask: GulpTask<any>, options?: ICumulativeManifestOptions): CumulativeManifestProcessor;
    ...
    private _insertManifestIntoMap(referencedProjectManifests, packagePath, packageName, fileModifiedTime, manifest);
