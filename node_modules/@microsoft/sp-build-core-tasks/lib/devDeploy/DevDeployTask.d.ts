...
export declare class DevDeployTask extends OdspGulpTask<IDevDeployTaskConfig> {
    ...
    private _doComponentTypeSpecificFixup(manifest, processPath);
    private _fixupIconPath(iconPath, processPath);
    private _doesFilenameAppearToContainHash(filePath);
}
