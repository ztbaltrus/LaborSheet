...
export declare class DebugManager {
    ...
    private static _handleDebugParameters(componentLoader, spfxDebugSessionVarData, queryParameters, isSpfxDebugEnabled);
    private static _handleNonTestModeDebugParameters(componentLoader, spfxDebugSessionVarData, queryParameters, isSpfxDebugEnabled, resolve);
    private static _getDebugScripts(componentLoader, resolve, registerAsNonDebug);
    private static _loadLoader(componentLoader, loaderUrl);
    private static _getUrlErrorText(url, paramName);
    private static _registerManifests(manifests, registerAsNonDebug);
}
