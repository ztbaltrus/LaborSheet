        ...
        return !this.state.dismissed
            ? (React.createElement("div", { role: 'dialog', "data-automation-id": 'debugManifestPromptDialog', "aria-labelledby": 'manifestWarningLabel' },
                React.createElement(Dialog, { dialogContentProps: {
                    ...
                    }, isOpen: this.state.showDialog, title: this.props.title, isBlocking: true, containerClassName: debugStyles.dialogContainer },
                ...
                React.createElement(Callout, { className: css(styles.callout, (_a = {}, _a[styles.calloutFadeIn] = !!this.state.showCallout, _a)), target: this._calloutTarget, directionalHint: 5 , gapSpace: 10 },
