...
export default class ManifestStore {
     ...
     *
     * e.g. 'd1d91016-032f-456d-98a4-721247c305e8' -> [ Version(1.0.0), Version(2.0.0) ]
     */
     ...
     *
     * e.g. { '1c6c9123-7aac-41f3-a376-3caea41ed83f', '7263c7d0-1d6a-45ec-8d85-d4d1d234171b' }
     */
     ...
     *
     * @returns Map<string, IManifestStoreEntry>: A map of manifest IDs to manifests.
     */
    ...
    /**
     * Removes the pin for a specific component id.
     * That means that other manifests can be added for the specified component id.
     *
     * @remarks
     * This is used exclusively for the React 16 rollout, as we will override a component from the assembly
     * with a copy that doesn't come from the assembly, with all its implications.
     * DO NOT CALL THIS FUNCTION IN ANY OTHER CASE
     *
     * @param componentId - Component id to remove the pin.
     */
    _unpinManifest(componentId: string): void;
    /**
    ...
    private _isManifestPinned(componentId);
     ...
     */
    private _removeManifest(id, version);
    /**
     * Internal implementation of `getManifest` that toggles whether failures should be logged or not.
     */
    private _getManifest(id, version, shouldLog);
    private _getManifestNotFoundErrorMessage(id, version?);
    private _getManifestFromStoreEntry(manifestEntry);
    private _addManifest(manifest, overwriteExisting);
    private _addDebugManifest(manifest);
    private _internalAddManifest(manifest, isDebug, overwriteExisting?);
    /**
     ...
     */
    private _addManifestToVersionsMap(manifest);
    /**
     ...
     */
    private _getExistingIndex(id, versionString?);
    /**
     ...
     */
    private _getUniqueManifestStoreIndex(id);
    private _createIndexFromManifest(manifest);
    private _createIndex(id, version);
    private _findDebugIndex(id, versions);
}
