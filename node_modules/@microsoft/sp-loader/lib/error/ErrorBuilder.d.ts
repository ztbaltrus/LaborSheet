...
export default class ErrorBuilder {
    ...
    private static buildErrorWithVerboseLog(errorCode, innerError, isExpected, source, eventName, ...params);
    private static buildErrorWithErrorLog(errorCode, innerError, isExpected, source, eventName, ...params);
}
