...
export default class PlatformLoader {
    ...
    private static _startApplication<TApplication>(preloadedData, serviceScope, qosMonitor);
    /**
     * Runs ApplicationManager.startApplication and properly catches errors coming from there.
     */
    private static _executePlatformCode<TApplication>(spApplicationBase, preloadedData, serviceScope, qosMonitor, error);
    /**
     * Runs ApplicationManager.startApplication and properly catches errors coming from there.
     */
    private static _runApplicationManager<TApplication>(spApplicationBase, preloadedData, serviceScope, qosMonitor, error);
    /**
     * Runs Navigator.navigateToApplication and properly catches errors coming from there.
     */
    private static _navigateToApplication<TApplication>(spApplicationBase, preloadedData, serviceScope, qosMonitor, error);
    /**
     * Loads sp-application-base component.
     * Rejects the promise if sp-application-base can't be loaded.
     */
    private static _loadSpApplicationBase<TPlatform>(error);
}
