...
import { react15Version, react16Version, reactComponentId, reactDomComponentId } from './utilities/componentConstants';
    ...
    BaseComponentLoader.prototype._startApplication = function (preloadedData) {
        ...
        if (_SPFlight.isEnabled(1187 )) {
            if (!ManifestStore.instance.tryGetManifest(reactComponentId, react16Version)) {
                ...
                ManifestStore.instance._unpinManifest(reactComponentId);
                ManifestStore.instance._unpinManifest(reactDomComponentId);
                waitingPromise = Promise.all([
                    ManifestStore.instance.requestManifest(reactComponentId, react16Version),
                    ManifestStore.instance.requestManifest(reactDomComponentId, react16Version)
                ]).then(function () {
                    ManifestStore.instance._pinManifest(reactComponentId);
                    ManifestStore.instance._pinManifest(reactDomComponentId);
                });
            }
        }
        else {
            ...
            if (!ManifestStore.instance.tryGetManifest(reactComponentId, react15Version)) {
                ...
                ManifestStore.instance._unpinManifest(reactDomComponentId);
                waitingPromise = Promise.all([
                    ManifestStore.instance.requestManifest(reactComponentId, react15Version),
                    ManifestStore.instance.requestManifest(reactDomComponentId, react15Version)
                ]).then(function () {
                    ManifestStore.instance._pinManifest(reactComponentId);
                    ManifestStore.instance._pinManifest(reactDomComponentId);
                });
