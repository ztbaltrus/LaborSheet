define(["require", "exports", "react", "react-dom", "./AppDefinition", "office-ui-fabric-react/lib/utilities/router/index", "./GettingStartedPage", "office-ui-fabric-react/lib/Utilities", "@uifabric/example-app-base", "@uifabric/icons/lib/index", "./index.scss", "./ColorStyles.scss"], function (require, exports, React, ReactDOM, AppDefinition_1, index_1, GettingStartedPage_1, Utilities_1, example_app_base_1, index_2) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    index_2.initializeIcons();
    Utilities_1.setBaseUrl('./dist/');
    example_app_base_1.ComponentPage.defaultProps.areBadgesVisible = true;
    var rootElement;
    ...
    function _onLoad() {
        ...
        ReactDOM.render(React.createElement(index_1.Router, { onNewRouteLoaded: _scrollAnchorLink }, _getRoutes()), rootElement);
    }
    function _getRoutes() {
