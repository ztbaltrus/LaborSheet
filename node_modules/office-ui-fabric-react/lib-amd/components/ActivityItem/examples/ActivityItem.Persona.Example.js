define(["require", "exports", "tslib", "react", "../../../Utilities", "..", "./ActivityItem.Example.styles", "../../../common/TestImages", "../../../Link"], function (require, exports, tslib_1, React, Utilities_1, __1, ActivityItem_Example_styles_1, TestImages_1, Link_1) {
    "use strict";
    ...
    var ActivityItemPersonaExample = /** @class */ (function (_super) {
        ...
        ActivityItemPersonaExample.prototype.render = function () {
            ...
            activityItemExamples.forEach(function (item) {
                var props = item;
                activityExampleList.push(React.createElement(__1.ActivityItem, tslib_1.__assign({}, props, { key: item.key, className: Utilities_1.css(classNames.exampleRoot) })));
            });
