define(["require", "exports", "tslib", "react", "@uifabric/example-app-base", "./examples/Image.Default.Example", "./examples/Image.Center.Example", "./examples/Image.Contain.Example", "./examples/Image.Cover.Example", "./examples/Image.None.Example", "./examples/Image.MaximizeFrame.Example", "../../demo/ComponentStatus/ComponentStatus", "./Image.checklist", "./ImagePage.scss"], function (require, exports, tslib_1, React, example_app_base_1, Image_Default_Example_1, Image_Center_Example_1, Image_Contain_Example_1, Image_Cover_Example_1, Image_None_Example_1, Image_MaximizeFrame_Example_1, ComponentStatus_1, Image_checklist_1) {
    ...
    var ImagePage = /** @class */ (function (_super) {
        ...
        ImagePage.prototype.render = function () {
            return (React.createElement(example_app_base_1.ComponentPage, { title: 'Image', componentName: 'ImageExample', componentUrl: 'https://github.com/OfficeDev/office-ui-fabric-react/tree/master/packages/office-ui-fabric-react/src/components/Image', exampleCards: React.createElement("div", null,
                    ...
                    React.createElement(example_app_base_1.ExampleCard, { title: 'Maximizing the image frame', code: ImageMaximizeFrameExampleCode },
                        React.createElement(Image_MaximizeFrame_Example_1.ImageMaximizeFrameExample, null))), allowNativeProps: true, nativePropsElement: 'img', propertiesTables: React.createElement(example_app_base_1.PropertiesTableSet, { sources: [
                        require('!raw-loader!office-ui-fabric-react/src/components/Image/Image.types.ts')
                    ] }), overview: React.createElement(example_app_base_1.PageMarkdown, null, require('!raw-loader!office-ui-fabric-react/src/components/Image/docs/ImageOverview.md')), bestPractices: React.createElement("div", null), dos: React.createElement(example_app_base_1.PageMarkdown, null, require('!raw-loader!office-ui-fabric-react/src/components/Image/docs/ImageDos.md')), donts: React.createElement(example_app_base_1.PageMarkdown, null, require('!raw-loader!office-ui-fabric-react/src/components/Image/docs/ImageDonts.md')), isHeaderVisible: this.props.isHeaderVisible, componentStatus: React.createElement(ComponentStatus_1.ComponentStatus, tslib_1.__assign({}, Image_checklist_1.ImageStatus)) }));
        };
        return ImagePage;
    }(React.Component));
