define(["require", "exports", "tslib", "react", "../PositioningContainer", "office-ui-fabric-react/lib/Button"], function (require, exports, tslib_1, React, PositioningContainer_1, Button_1) {
    "use strict";
        ...
        PositioningContainerBasicExample.prototype.render = function () {
            ...
            return (React.createElement("div", null,
                React.createElement("div", { className: 'ms-PositioningContainerBasicExample-buttonArea' },
                    React.createElement(Button_1.DefaultButton, { onClick: this._onShowMenuClicked, text: isPositioningContainerVisible ? 'Hide Positioning Container' : 'Show Positioning Container', className: 'ms-PositioningContainer-basicExampleButton' })),
                isPositioningContainerVisible && (React.createElement(PositioningContainer_1.PositioningContainer, { className: 'ms-PositioningContainer', role: 'alertdialog', target: '.ms-PositioningContainer-basicExampleButton', onDismiss: this._onDismiss, setInitialFocus: true },
