define(["require", "exports", "tslib", "react", "react-dom", "../../Utilities", "../../FocusZone", "../../Icon", "../../Layer", "../GroupedList/GroupSpacer", "../../GroupedList", "./DetailsRowCheck", "./DetailsRowCheck.scss", "../../utilities/selection/interfaces", "./DetailsHeader.scss", "./../../utilities/dragdrop", "./../../components/DetailsList/DetailsColumn"], function (require, exports, tslib_1, React, react_dom_1, Utilities_1, FocusZone_1, Icon_1, Layer_1, GroupSpacer_1, GroupedList_1, DetailsRowCheck_1, checkStylesModule, interfaces_1, stylesImport, dragdrop_1, DetailsColumn_1) {
    "use strict";
    ...
    var DetailsHeader = /** @class */ (function (_super) {
        ...
        DetailsHeader.prototype._renderDropHint = function (dropHintIndex) {
            return (React.createElement("div", { key: 'dropHintKey', className: styles.dropHintStyle, id: "columnDropHint_" + dropHintIndex },
                React.createElement("div", { key: "dropHintCircleKey", "aria-hidden": true, "data-is-focusable": false, "data-sizer-index": dropHintIndex, className: Utilities_1.css('ms-DetailsHeader-dropHintCircleStyle', styles.dropHintCircleStyle) }),
