define(["require", "exports", "tslib", "react", "@uifabric/example-app-base", "./Button.checklist", "./examples/Button.Default.Example", "./examples/Button.ContextualMenu.Example", "./examples/Button.Compound.Example", "./examples/Button.Action.Example", "./examples/Button.CommandBar.Example", "./examples/Button.Icon.Example", "./examples/Button.Anchor.Example", "./examples/Button.ScreenReader.Example", "./examples/Button.Swap.Example", "./examples/Button.Split.Example", "../../demo/ComponentStatus/ComponentStatus", "office-ui-fabric-react/lib/Checkbox", "../../common/_exampleStyles.scss"], function (require, exports, tslib_1, React, example_app_base_1, Button_checklist_1, Button_Default_Example_1, Button_ContextualMenu_Example_1, Button_Compound_Example_1, Button_Action_Example_1, Button_CommandBar_Example_1, Button_Icon_Example_1, Button_Anchor_Example_1, Button_ScreenReader_Example_1, Button_Swap_Example_1, Button_Split_Example_1, ComponentStatus_1, Checkbox_1, exampleStylesImport) {
    "use strict";
