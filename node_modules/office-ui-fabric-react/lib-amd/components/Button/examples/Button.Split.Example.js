define(["require", "exports", "tslib", "react", "../../../Utilities", "./Button.Basic.Example.styles", "office-ui-fabric-react/lib/Button", "office-ui-fabric-react/lib/Label", "./Button.Split.Example.styles"], function (require, exports, tslib_1, React, Utilities_1, Button_Basic_Example_styles_1, Button_1, Label_1, Button_Split_Example_styles_1) {
    "use strict";
        ...
        ButtonSplitExample.prototype.render = function () {
            ...
            return (React.createElement("div", { className: Utilities_1.css(classNames.twoup) },
                ...
                React.createElement("div", null,
                    ...
                    React.createElement(Button_1.DefaultButton, { primary: true, "data-automation-id": 'test', disabled: true, checked: checked, text: 'Create account', onClick: alertClicked, split: true, style: { height: '35px' }, menuProps: {
                            items: [
                                {
                                    key: 'emailMessage',
                                    name: 'Email message',
