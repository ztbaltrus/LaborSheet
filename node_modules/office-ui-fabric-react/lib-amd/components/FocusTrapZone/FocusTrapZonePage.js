define(["require", "exports", "tslib", "react", "@uifabric/example-app-base", "./examples/FocusTrapZone.Box.Example", "./examples/FocusTrapZone.Box.FocusOnCustomElement.Example", "./examples/FocusTrapZone.Box.Click.Example", "./examples/FocusTrapZone.Nested.Example"], function (require, exports, tslib_1, React, example_app_base_1, FocusTrapZone_Box_Example_1, FocusTrapZone_Box_FocusOnCustomElement_Example_1, FocusTrapZone_Box_Click_Example_1, FocusTrapZone_Nested_Example_1) {
    "use strict";
    ...
    var FocusTrapZonePage = /** @class */ (function (_super) {
        ...
        FocusTrapZonePage.prototype.render = function () {
            return (React.createElement(example_app_base_1.ComponentPage, { title: 'FocusTrapZone', componentName: 'FocusTrapZoneExample', componentUrl: 'https://github.com/OfficeDev/office-ui-fabric-react/tree/master/packages/office-ui-fabric-react/src/components/FocusTrapZone', exampleCards: React.createElement("div", null,
                    ...
                    React.createElement(example_app_base_1.ExampleCard, { title: 'Multiple Nest FocusTrapZones', code: FocusTrapZoneNestedExampleCode },
                        React.createElement(FocusTrapZone_Nested_Example_1.default, null))), allowNativeProps: true, propertiesTables: React.createElement(example_app_base_1.PropertiesTableSet, { sources: [
                        require('!raw-loader!office-ui-fabric-react/src/components/FocusTrapZone/FocusTrapZone.types.ts')
                    ] }), overview: React.createElement(example_app_base_1.PageMarkdown, null, require('!raw-loader!office-ui-fabric-react/src/components/FocusTrapZone/docs/FocusTrapZoneOverview.md')), isHeaderVisible: this.props.isHeaderVisible }));
        };
