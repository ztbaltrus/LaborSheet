define(["require", "exports", "tslib", "react", "office-ui-fabric-react/lib/Layer", "@uifabric/example-app-base", "./examples/Tooltip.Custom.Example", "./examples/Tooltip.Basic.Example", "./examples/Tooltip.Interactive.Example", "./examples/Tooltip.Overflow.Example", "./examples/Tooltip.NoScroll.Example", "../../demo/ComponentStatus/ComponentStatus", "./Tooltip.checklist", "./TooltipPage.scss"], function (require, exports, tslib_1, React, Layer_1, example_app_base_1, Tooltip_Custom_Example_1, Tooltip_Basic_Example_1, Tooltip_Interactive_Example_1, Tooltip_Overflow_Example_1, Tooltip_NoScroll_Example_1, ComponentStatus_1, Tooltip_checklist_1) {
    "use strict";
        ...
        TooltipPage.prototype.render = function () {
            return (React.createElement(example_app_base_1.ComponentPage, { title: 'Tooltip', componentName: 'TooltipExample', componentUrl: 'https://github.com/OfficeDev/office-ui-fabric-react/tree/master/packages/office-ui-fabric-react/src/components/Tooltip', exampleCards: React.createElement(Layer_1.LayerHost, null,
                    ...
                    React.createElement(example_app_base_1.ExampleCard, { title: 'Tooltip only on overflow', code: TooltipOverflowExampleCode },
                        React.createElement(Tooltip_Overflow_Example_1.TooltipOverflowExample, null)),
                    React.createElement(example_app_base_1.ExampleCard, { title: 'Tooltip without scrollbar (may improve performance)', code: TooltipNoScrollExampleCode },
                        React.createElement(Tooltip_NoScroll_Example_1.TooltipNoScrollExample, null))), allowNativeProps: true, propertiesTables: React.createElement(example_app_base_1.PropertiesTableSet, { sources: [
