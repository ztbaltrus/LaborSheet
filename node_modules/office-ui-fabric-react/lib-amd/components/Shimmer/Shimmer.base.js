define(["require", "exports", "tslib", "react", "../../Utilities", "./ShimmerElementsGroup/ShimmerElementsGroup"], function (require, exports, tslib_1, React, Utilities_1, ShimmerElementsGroup_1) {
    "use strict";
    ...
    var ShimmerBase = /** @class */ (function (_super) {
        ...
        ShimmerBase.prototype.render = function () {
            var _a = this.props, getStyles = _a.getStyles, shimmerElements = _a.shimmerElements, children = _a.children, isDataLoaded = _a.isDataLoaded, width = _a.width, className = _a.className, customElementsGroup = _a.customElementsGroup, theme = _a.theme, ariaLabel = _a.ariaLabel;
            ...
            return (React.createElement("div", tslib_1.__assign({}, divProps, { className: this._classNames.root }),
                !contentLoaded && (React.createElement("div", { style: { width: width ? width : '100%' }, className: this._classNames.shimmerWrapper }, customElementsGroup ? customElementsGroup : React.createElement(ShimmerElementsGroup_1.ShimmerElementsGroup, { shimmerElements: shimmerElements }))),
        ...
        ShimmerBase = tslib_1.__decorate([
            Utilities_1.customizable('Shimmer', ['theme'])
        ], ShimmerBase);
        return ShimmerBase;
