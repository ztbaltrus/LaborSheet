define(["require", "exports", "tslib", "react", "../../../Utilities"], function (require, exports, tslib_1, React, Utilities_1) {
    ...
    var ShimmerLineBase = /** @class */ (function (_super) {
        ...
        ShimmerLineBase.prototype.render = function () {
            var _a = this.props, height = _a.height, getStyles = _a.getStyles, width = _a.width, borderStyle = _a.borderStyle, theme = _a.theme;
        ...
        ShimmerLineBase = tslib_1.__decorate([
            Utilities_1.customizable('ShimmerLine', ['theme'])
        ], ShimmerLineBase);
