define(["require", "exports", "tslib", "react", "../../../Utilities", "../Shimmer.types", "../ShimmerLine/ShimmerLine", "../ShimmerGap/ShimmerGap", "../ShimmerCircle/ShimmerCircle"], function (require, exports, tslib_1, React, Utilities_1, Shimmer_types_1, ShimmerLine_1, ShimmerGap_1, ShimmerCircle_1) {
    ...
    var ShimmerElementsGroupBase = /** @class */ (function (_super) {
                ...
                var renderedElements = shimmerElements ? (shimmerElements.map(function (elem, index) {
                    ...
                    switch (elem.type) {
                        case Shimmer_types_1.ShimmerElementType.circle:
                            return React.createElement(ShimmerCircle_1.ShimmerCircle, tslib_1.__assign({ key: index }, filteredElem, { getStyles: _this._getBorderStyles(elem, rowHeight) }));
                        case Shimmer_types_1.ShimmerElementType.gap:
                            return React.createElement(ShimmerGap_1.ShimmerGap, tslib_1.__assign({ key: index }, filteredElem, { getStyles: _this._getBorderStyles(elem, rowHeight) }));
                        case Shimmer_types_1.ShimmerElementType.line:
                            return React.createElement(ShimmerLine_1.ShimmerLine, tslib_1.__assign({ key: index }, filteredElem, { getStyles: _this._getBorderStyles(elem, rowHeight) }));
                    }
                })) : (React.createElement(ShimmerLine_1.ShimmerLine, { height: Shimmer_types_1.ShimmerElementsDefaultHeights.line, getStyles: _this._getDefaultLineStyle }));
        ...
        ShimmerElementsGroupBase = tslib_1.__decorate([
            Utilities_1.customizable('ShimmerElementsGroup', ['theme'])
