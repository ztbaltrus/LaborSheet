define(["require", "exports", "../../Utilities", "../../utilities/keytips/KeytipUtils", "../../utilities/keytips/KeytipConstants"], function (require, exports, Utilities_1, KeytipUtils_1, KeytipConstants_1) {
    ...
    var KeytipTree = /** @class */ (function () {
        ...
        KeytipTree.prototype.addNode = function (keytipProps, uniqueID, persisted) {
            ...
            var node = this._createNode(nodeID, keySequences, parentID, [], hasDynamicChildren, overflowSetSequence, hasMenu, onExecute, onReturn, disabled, persisted);
        ...
        KeytipTree.prototype._createNode = function (id, keySequences, parentId, children, hasDynamicChildren, overflowSetSequence, hasMenu, onExecute, onReturn, disabled, persisted) {
            var _this = this;
            var node = {
                id: id,
