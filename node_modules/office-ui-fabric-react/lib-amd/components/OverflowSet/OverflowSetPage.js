define(["require", "exports", "tslib", "react", "office-ui-fabric-react/lib/Layer", "@uifabric/example-app-base", "./examples/OverflowSet.Custom.Example", "./examples/OverflowSet.Basic.Example", "./examples/OverflowSet.Vertical.Example", "../../demo/ComponentStatus/ComponentStatus", "./OverflowSet.checklist"], function (require, exports, tslib_1, React, Layer_1, example_app_base_1, OverflowSet_Custom_Example_1, OverflowSet_Basic_Example_1, OverflowSet_Vertical_Example_1, ComponentStatus_1, OverflowSet_checklist_1) {
    "use strict";
    ...
    var OverflowSetPage = /** @class */ (function (_super) {
        ...
        OverflowSetPage.prototype.render = function () {
            return (React.createElement(example_app_base_1.ComponentPage, { title: 'OverflowSet', componentName: 'OverflowSetExample', componentUrl: 'https://github.com/OfficeDev/office-ui-fabric-react/tree/master/packages/office-ui-fabric-react/src/components/OverflowSet', overview: React.createElement(example_app_base_1.PageMarkdown, null, require('!raw-loader!office-ui-fabric-react/src/components/OverflowSet/docs/OverflowSetOverview.md')), allowNativeProps: true, exampleCards: React.createElement(Layer_1.LayerHost, null,
