    ...
    var TextFieldOnRenderDescriptionExample = /** @class */ (function (_super) {
        ...
        TextFieldOnRenderDescriptionExample.prototype.render = function () {
            return (React.createElement("div", { className: 'docs-TextFieldExample' },
                React.createElement(TextField_1.TextField, { description: 'A custom description that appends a link.', onRenderDescription: this._onRenderDescription })));
        };
        return TextFieldOnRenderDescriptionExample;
    }(React.Component));
    exports.TextFieldOnRenderDescriptionExample = TextFieldOnRenderDescriptionExample;
});
