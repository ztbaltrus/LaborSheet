define(["require", "exports", "tslib", "react", "../../../Checkbox", "../Layer", "../LayerHost", "../../../Toggle", "../../../Styling", "../../../common/_exampleStyles.scss", "./Layer.Example.scss"], function (require, exports, tslib_1, React, Checkbox_1, Layer_1, LayerHost_1, Toggle_1, Styling_1, exampleStylesImport) {
    "use strict";
    ...
    var LayerHostedExample = /** @class */ (function (_super) {
        ...
        function LayerHostedExample(props) {
            ...
            _this._onChangeToggle = function (checked) {
        ...
        LayerHostedExample.prototype.render = function () {
            ...
            return (React.createElement("div", null,
                React.createElement(Toggle_1.Toggle, { label: 'Show host', checked: showHost, onChanged: this._onChangeToggle }),
                showHost && (React.createElement(LayerHost_1.LayerHost, { id: 'layerhost1', className: 'LayerExample-customHost' })),
