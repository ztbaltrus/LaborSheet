define(["require", "exports", "tslib", "react", "../../../Utilities", "./SuggestionsCore", "./SuggestionsControl.scss"], function (require, exports, tslib_1, React, Utilities_1, SuggestionsCore_1, stylesImport) {
    ...
    var SuggestionsHeaderFooterItem = /** @class */ (function (_super) {
        ...
        SuggestionsHeaderFooterItem.prototype.render = function () {
            ...
            return (onExecute ?
                (React.createElement("button", { id: id, onClick: onExecute, className: Utilities_1.css('ms-Suggestions-sectionButton', styles.actionButton, (_b = {},
                        _b['is-selected ' + styles.buttonSelected] = isSelected,
                        _b)) }, renderItem())) :
                (React.createElement("div", { id: id, className: Utilities_1.css('ms-Suggestions-section', styles.suggestionsTitle) }, renderItem())));
            var _b;
        };
    ...
    var SuggestionsControl = /** @class */ (function (_super) {
        ...
        SuggestionsControl.prototype.componentWillReceiveProps = function () {
            this.resetSelectedItem();
        };
        ...
        SuggestionsControl.prototype.renderHeaderItems = function () {
            ...
            return headerItemsProps ? (React.createElement("div", { className: Utilities_1.css('ms-Suggestions-headerContainer', styles.suggestionsContainer), id: 'suggestionHeader-list', role: 'list', "aria-label": suggestionsHeaderContainerAriaLabel }, headerItemsProps.map(function (headerItemProps, index) {
                ...
                return (headerItemProps.shouldShow() ? React.createElement("div", { ref: _this._resolveRef(isSelected ? '_selectedElement' : ''), id: 'sug-header' + index, role: 'listitem', "aria-label": headerItemProps.ariaLabel },
        ...
        SuggestionsControl.prototype.renderFooterItems = function () {
            ...
            return footerItemsProps ? (React.createElement("div", { className: Utilities_1.css('ms-Suggestions-footerContainer', styles.suggestionsContainer), id: 'suggestionFooter-list', role: 'list', "aria-label": suggestionsFooterContainerAriaLabel }, footerItemsProps.map(function (footerItemProps, index) {
                ...
                return (footerItemProps.shouldShow() ? React.createElement("div", { ref: _this._resolveRef(isSelected ? '_selectedElement' : ''), id: 'sug-footer' + index, role: 'listitem', "aria-label": footerItemProps.ariaLabel },
        ...
        SuggestionsControl.prototype._renderSuggestions = function () {
            ...
            return (React.createElement(TypedSuggestions, tslib_1.__assign({ ref: this._resolveRef('_suggestions') }, this.props)));
        };
        /**
       ...
       */
        SuggestionsControl.prototype._selectPreviousItemOfItemType = function (itemType, currentIndex) {
            if (itemType === SuggestionItemType.suggestion) {
                var index = currentIndex !== undefined ? currentIndex : this.props.suggestions.length;
                if (index > 0) {
