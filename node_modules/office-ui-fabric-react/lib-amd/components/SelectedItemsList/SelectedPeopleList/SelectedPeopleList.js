        ...
        SelectedPeopleList.prototype._renderItem = function (item, index) {
            ...
            if (item.isEditing) {
                ...
                return (props.menuItems.length > 0 ?
                    (React.createElement(SelectedItemWithContextMenu_1.SelectedItemWithContextMenu, { renderedItem: renderedItem, beginEditing: this._beginEditing, menuItems: this._createMenuItems(props.item), item: props.item }))
                    : renderedItem);
            }
        };
        // tslint:disable-next-line:no-any
