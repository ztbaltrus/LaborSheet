define(["require", "exports", "tslib", "react", "@uifabric/example-app-base", "./examples/Panel.SmallRight.Example", "./examples/Panel.SmallLeft.Example", "./examples/Panel.SmallFluid.Example", "./examples/Panel.Medium.Example", "./examples/Panel.Large.Example", "./examples/Panel.LargeFixed.Example", "./examples/Panel.ExtraLarge.Example", "./examples/Panel.Custom.Example", "./examples/Panel.HiddenOnDismiss.Example", "./examples/Panel.LightDismiss.Example", "./examples/Panel.LightDismissCustom.Example", "./examples/Panel.NonModal.Example", "./examples/Panel.Footer.Example", "../../demo/ComponentStatus/ComponentStatus", "./Panel.checklist"], function (require, exports, tslib_1, React, example_app_base_1, Panel_SmallRight_Example_1, Panel_SmallLeft_Example_1, Panel_SmallFluid_Example_1, Panel_Medium_Example_1, Panel_Large_Example_1, Panel_LargeFixed_Example_1, Panel_ExtraLarge_Example_1, Panel_Custom_Example_1, Panel_HiddenOnDismiss_Example_1, Panel_LightDismiss_Example_1, Panel_LightDismissCustom_Example_1, Panel_NonModal_Example_1, Panel_Footer_Example_1, ComponentStatus_1, Panel_checklist_1) {
    "use strict";
    ...
    var PanelPage = /** @class */ (function (_super) {
        ...
        PanelPage.prototype.render = function () {
            return (React.createElement(example_app_base_1.ComponentPage, { title: 'Panel', componentName: 'PanelExample', componentUrl: 'https://github.com/OfficeDev/office-ui-fabric-react/tree/master/packages/office-ui-fabric-react/src/components/Panel', allowNativeProps: true, exampleCards: React.createElement("div", null,
                    ...
                    React.createElement(example_app_base_1.ExampleCard, { title: 'Panel - Hidden on Dismiss', code: PanelHiddenOnDismissExampleCode },
                        React.createElement(Panel_HiddenOnDismiss_Example_1.PanelHiddenOnDismissExample, null)),
                    ...
                    React.createElement(example_app_base_1.ExampleCard, { title: 'Panel - Custom Light Dismiss', code: PanelLightDismissCustomExampleCode },
                        React.createElement(Panel_LightDismissCustom_Example_1.PanelLightDismissCustomExample, null)),
                    ...
                    ] }), overview: React.createElement(example_app_base_1.PageMarkdown, null, require('!raw-loader!office-ui-fabric-react/src/components/Panel/docs/PanelOverview.md')), bestPractices: React.createElement("div", null), dos: React.createElement(example_app_base_1.PageMarkdown, null, require('!raw-loader!office-ui-fabric-react/src/components/Panel/docs/PanelDos.md')), donts: React.createElement(example_app_base_1.PageMarkdown, null, require('!raw-loader!office-ui-fabric-react/src/components/Panel/docs/PanelDonts.md')), isHeaderVisible: this.props.isHeaderVisible, componentStatus: React.createElement(ComponentStatus_1.ComponentStatus, tslib_1.__assign({}, Panel_checklist_1.PanelStatus)) }));
        };
        return PanelPage;
    }(React.Component));
