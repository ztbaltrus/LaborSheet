define(["require", "exports", "tslib", "react", "prop-types", "../../Utilities"], function (require, exports, tslib_1, React, PropTypes, Utilities_1) {
    ...
    var ScrollablePaneBase = /** @class */ (function (_super) {
        ...
        function ScrollablePaneBase(props) {
            ...
            _this._getStickyContainerStyle = function (height) {
                return {
                    height: height,
                    width: _this.contentContainer ? _this.contentContainer.clientWidth : '100%'
                };
            };
        ...
        ScrollablePaneBase.prototype.render = function () {
            ...
            return (React.createElement("div", tslib_1.__assign({}, Utilities_1.getNativeProps(this.props, Utilities_1.divProperties), { ref: this._root, className: classNames.root }),
                ...
                React.createElement("div", { ref: this._stickyAboveRef, className: classNames.stickyAbove, style: this._getStickyContainerStyle(stickyTopHeight) }),
                React.createElement("div", { className: classNames.stickyBelow, style: this._getStickyContainerStyle(stickyBottomHeight) },
