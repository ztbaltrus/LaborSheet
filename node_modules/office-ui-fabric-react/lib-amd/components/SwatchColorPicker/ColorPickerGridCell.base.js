        ...
        function ColorPickerGridCellBase() {
           ...
           */
            _this._onRenderColorOption = function (colorOption) {
                ...
                return (React.createElement("svg", { className: _this._classNames.svg, viewBox: '0 0 20 20', fill: colors_1.getColorFromString(colorOption.color).str }, _this.props.circle ?
