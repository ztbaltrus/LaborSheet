define(["require", "exports", "tslib", "react", "@uifabric/example-app-base", "./examples/Picker.CustomResult.Example", "./examples/TagPicker.Basic.Example", "../../demo/ComponentStatus/ComponentStatus", "./Pickers.checklist"], function (require, exports, tslib_1, React, example_app_base_1, Picker_CustomResult_Example_1, TagPicker_Basic_Example_1, ComponentStatus_1, Pickers_checklist_1) {
    "use strict";
    ...
    var PickersPage = /** @class */ (function (_super) {
        ...
        PickersPage.prototype.render = function () {
            return (React.createElement(example_app_base_1.ComponentPage, { title: 'Pickers', componentName: 'PickersExample', componentUrl: 'https://github.com/OfficeDev/office-ui-fabric-react/tree/master/packages/office-ui-fabric-react/src/components/pickers', exampleCards: React.createElement("div", null,
                    ...
                    ] }), overview: React.createElement(example_app_base_1.PageMarkdown, null, require('!raw-loader!office-ui-fabric-react/src/components/pickers/docs/PickersOverview.md')), isHeaderVisible: this.props.isHeaderVisible, componentStatus: React.createElement(ComponentStatus_1.ComponentStatus, tslib_1.__assign({}, Pickers_checklist_1.PickersStatus)) }));
        };
        return PickersPage;
    }(React.Component));
