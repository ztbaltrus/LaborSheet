    ...
    var SearchBoxFullSizeExample = /** @class */ (function (_super) {
        ...
        SearchBoxFullSizeExample.prototype.render = function () {
            return (React.createElement("div", { className: 'ms-SearchBoxExample' },
                React.createElement(SearchBox_1.SearchBox, { placeholder: 'Search', onFocus: function () { return console.log('onFocus called'); }, onBlur: function () { return console.log('onBlur called'); }, onChange: function () { return console.log('onChange called'); } }),
                React.createElement(SearchBox_1.SearchBox, { placeholder: 'Search with no animation', onFocus: function () { return console.log('onFocus called'); }, onBlur: function () { return console.log('onBlur called'); }, onChange: function () { return console.log('onChange called'); }, disableAnimation: true })));
        };
