define(["require", "exports", "tslib", "react", "office-ui-fabric-react/lib/Rating", "../../../Styling", "./Rating.Basic.Example.scss"], function (require, exports, tslib_1, React, Rating_1, Styling_1) {
    "use strict";
    ...
    var RatingBasicExample = /** @class */ (function (_super) {
        ...
        function RatingBasicExample(props) {
            ...
            _this._onLargeStarChanged = function (rating) {
                _this.setState({
                    largeStarRating: rating
                });
            };
            _this._onSmallStarChanged = function (rating) {
                _this.setState({
                    smallStarRating: rating
                });
            };
            _this._onTenStarChanged = function (rating) {
                _this.setState({
                    tenStarRating: rating
                });
            };
            _this._onThemedStarChanged = function (rating) {
                _this.setState({
