define(["require", "exports", "tslib", "react", "office-ui-fabric-react/lib/Button", "office-ui-fabric-react/lib/TextField", "./ContextualMenuExample.scss"], function (require, exports, tslib_1, React, Button_1, TextField_1) {
    ...
    var ContextualMenuSubmenuExample = /** @class */ (function (_super) {
        ...
        function ContextualMenuSubmenuExample(props) {
            ...
            _this._onHoverDelayChanged = function (newValue) {
                _this.setState({
                    hoverDelay: +newValue
                });
            };
        ...
        ContextualMenuSubmenuExample.prototype.render = function () {
            return (React.createElement("div", null,
                React.createElement(TextField_1.TextField, { value: String(this.state.hoverDelay), onChanged: this._onHoverDelayChanged }),
