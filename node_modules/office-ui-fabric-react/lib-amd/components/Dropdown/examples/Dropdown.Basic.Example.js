define(["require", "exports", "tslib", "react", "office-ui-fabric-react/lib/Button", "office-ui-fabric-react/lib/Dropdown", "../../../Utilities", "./Dropdown.Basic.Example.scss"], function (require, exports, tslib_1, React, Button_1, Dropdown_1, Utilities_1) {
    "use strict";
    ...
    var DropdownBasicExample = /** @class */ (function (_super) {
        ...
        function DropdownBasicExample(props) {
            ...
            _this._basicDropdown = Utilities_1.createRef();
            _this.changeState = function (item) {
        ...
        DropdownBasicExample.prototype.render = function () {
            ...
            return (React.createElement("div", { className: 'docs-DropdownExample' },
                ...
                React.createElement(Dropdown_1.Dropdown, { label: 'Controlled example:', selectedKey: (selectedItem ? selectedItem.key : undefined), onChanged: this.changeState, onFocus: this._log('onFocus called'), onBlur: this._log('onBlur called'), placeHolder: 'Select an Option', options: [
                        { key: 'A', text: 'Option a' },
                        { key: 'B', text: 'Option b' },
                        { key: 'C', text: 'Option c' },
                        { key: 'D', text: 'Option d' },
                ...
                React.createElement(Dropdown_1.Dropdown, { placeHolder: 'Select options', label: 'Multi-Select uncontrolled example:', defaultSelectedKeys: ['Apple', 'Banana', 'Orange'], onFocus: this._log('onFocus called'), onBlur: this._log('onBlur called'), multiSelect: true, options: [
