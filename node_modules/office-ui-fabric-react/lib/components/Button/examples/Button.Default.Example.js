    ...
    ButtonDefaultExample.prototype.render = function () {
        ...
        return (React.createElement("div", { className: Utilities_1.css(classNames.twoup) },
            React.createElement("div", null,
                ...
                React.createElement(Button_1.DefaultButton, { "data-automation-id": 'test', disabled: disabled, checked: checked, text: 'Button' })),
            React.createElement("div", null,
                React.createElement(Label_1.Label, null, "Primary"),
                React.createElement(Button_1.DefaultButton, { primary: true, "data-automation-id": 'test', disabled: disabled, checked: checked, text: 'Button', onClick: this._alertClicked }))));
    };
