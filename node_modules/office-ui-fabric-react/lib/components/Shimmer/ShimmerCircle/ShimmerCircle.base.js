...
var ShimmerCircleBase = /** @class */ (function (_super) {
    ...
    ShimmerCircleBase.prototype.render = function () {
        var _a = this.props, height = _a.height, getStyles = _a.getStyles, borderStyle = _a.borderStyle, theme = _a.theme;
    ...
    ShimmerCircleBase = tslib_1.__decorate([
        Utilities_1.customizable('ShimmerCircle', ['theme'])
    ], ShimmerCircleBase);
