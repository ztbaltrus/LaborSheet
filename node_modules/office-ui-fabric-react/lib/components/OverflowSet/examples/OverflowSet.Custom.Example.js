...
var OverflowSetCustomExample = /** @class */ (function (_super) {
        ...
        return (React.createElement(OverflowSet_1.OverflowSet, { items: [
                {
                    ...
                    onRender: function (item) {
                        return (React.createElement(SearchBox_1.SearchBox, { placeholder: 'Search' }));
                    }
                },
                {
                    key: 'newItem',
    ...
    OverflowSetCustomExample.prototype._onRenderOverflowButton = function (overflowItems) {
        return (React.createElement(Button_1.DefaultButton, { className: Utilities_1.css(styles.overflowButton), menuIconProps: { iconName: 'More' }, menuProps: { items: overflowItems } }));
    };
