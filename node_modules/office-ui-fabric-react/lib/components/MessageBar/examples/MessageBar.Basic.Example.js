...
exports.MessageBarBasicExample = function () { return (React.createElement("div", { className: 'ms-BasicMessageBarsExample' },
    ...
    React.createElement(MessageBar_1.MessageBar, { messageBarType: MessageBar_1.MessageBarType.blocked, isMultiline: false, onDismiss: log('test'), dismissButtonAriaLabel: 'Close', truncated: true, overflowButtonAriaLabel: 'Overflow' },
