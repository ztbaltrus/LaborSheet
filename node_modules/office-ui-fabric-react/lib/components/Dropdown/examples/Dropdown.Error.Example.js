...
var DropdownErrorExample = /** @class */ (function (_super) {
    ...
    DropdownErrorExample.prototype.render = function () {
        return (React.createElement("div", { className: 'docs-DropdownExample' },
            React.createElement(Dropdown_1.Dropdown, { placeHolder: 'Select an Option', label: 'Error message example:', id: 'Errormessagedrop1', ariaLabel: 'Error message dropdown example', options: [
                    { key: 'A', text: 'Option a' },
                    { key: 'B', text: 'Option b' },
                    { key: 'C', text: 'Option c' },
                    { key: 'D', text: 'Option d' },
