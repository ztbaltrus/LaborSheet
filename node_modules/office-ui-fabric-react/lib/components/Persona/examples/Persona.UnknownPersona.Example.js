...
var UnknownPersonaExample = /** @class */ (function (_super) {
    ...
    UnknownPersonaExample.prototype.render = function () {
        return (React.createElement("div", { className: 'ms-PersonaExample' },
            ...
            React.createElement(Persona_1.Persona, { showUnknownPersonaCoin: true, text: 'Kat Larrson', secondaryText: 'Designer', tertiaryText: 'Unverified sender', size: Persona_1.PersonaSize.size72 })));
    };
