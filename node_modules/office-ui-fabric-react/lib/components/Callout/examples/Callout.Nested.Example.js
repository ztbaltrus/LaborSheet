    ...
    CalloutNestedExample.prototype.render = function () {
        ...
        return (React.createElement("div", { className: 'ms-CalloutExample' },
            ...
            isCalloutVisible ? (React.createElement("div", null,
                React.createElement(Callout_1.Callout, { role: 'alertdialog', ariaLabelledBy: 'callout-label-2', className: 'ms-CalloutExample-callout', gapSpace: 0, target: this._menuButtonElement, onDismiss: this._onDismiss, setInitialFocus: true },
