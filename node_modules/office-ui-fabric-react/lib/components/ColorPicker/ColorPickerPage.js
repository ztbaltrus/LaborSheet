...
var ColorPicker_checklist_1 = require("./ColorPicker.checklist");
...
var ColorPickerPage = /** @class */ (function (_super) {
    ...
    ColorPickerPage.prototype.render = function () {
        return (React.createElement(example_app_base_1.ComponentPage, { title: 'ColorPicker', componentName: 'ColorPickerExample', componentUrl: 'https://github.com/OfficeDev/office-ui-fabric-react/tree/master/packages/office-ui-fabric-react/src/components/ColorPicker', exampleCards: React.createElement(example_app_base_1.ExampleCard, { title: 'Default ColorPicker', code: ColorPickerBasicExampleCode },
                ...
                ] }), overview: React.createElement(example_app_base_1.PageMarkdown, null, require('!raw-loader!office-ui-fabric-react/src/components/ColorPicker/docs/ColorPickerOverview.md')), isHeaderVisible: this.props.isHeaderVisible, componentStatus: React.createElement(ComponentStatus_1.ComponentStatus, tslib_1.__assign({}, ColorPicker_checklist_1.ColorPickerStatus)) }));
    };
