...
var AllComponents_checklist_1 = require("./AllComponents.checklist");
var ComponentStatusState_1 = require("./ComponentStatusState");
var ComponentStatus_1 = require("./ComponentStatus");
require("./ComponentStatusPage.scss");
var ComponentStatusPage = /** @class */ (function (_super) {
    ...
    ComponentStatusPage.prototype.render = function () {
        ...
        return (React.createElement(example_app_base_1.ComponentPage, { title: 'Components Checklist', componentName: 'Components Checklist', editOverviewUrl: 'https://github.com/OfficeDev/office-ui-fabric-react/tree/master/packages/office-ui-fabric-react/src/demo/ComponentStatus/docs/ComponentChecklistOverview.md', overview: this._renderOverView(), otherSections: sections }));
    };
    ComponentStatusPage.prototype._renderOverView = function () {
        return (React.createElement(example_app_base_1.PageMarkdown, null, require('!raw-loader!office-ui-fabric-react/src/demo/ComponentStatus/docs/ComponentChecklistOverview.md')));
    };
