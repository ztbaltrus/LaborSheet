...
import { IPositionDirectionalHintData, IPositionedData, IPoint, ICalloutPositionedInfo, IPositionProps, RectangleEdge, IRelativePositions } from './positioning.types';
...
export declare const __positioningTestPackage: {
    ...
    _getPositionData: (directionalHint?: DirectionalHint, directionalHintForRTL?: DirectionalHint | undefined, previousPositions?: IPositionedData | undefined) => IPositionDirectionalHintData;
 ...
 * @returns
 */
export declare function _getRelativePositions(props: IPositionProps, hostElement: HTMLElement, elementToPosition: HTMLElement): IRelativePositions;
/**
 * @deprecated Do not use, this will be removed in 6.0.
