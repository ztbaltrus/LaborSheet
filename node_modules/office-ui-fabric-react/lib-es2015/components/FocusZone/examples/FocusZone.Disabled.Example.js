...
export var FocusZoneDisabledExample = function () { return (React.createElement("div", { className: 'ms-FocusZoneDisabledExample' },
    React.createElement("div", { className: 'ms-Row' },
        React.createElement(FocusZone, { direction: FocusZoneDirection.horizontal },
            ...
            React.createElement(TextField, { value: 'FocusZone TextField', className: 'ms-FocusZoneDisabledExample-textField' }),
    ...
    React.createElement("div", { className: 'ms-Row' },
        React.createElement(FocusZone, { disabled: true },
            ...
            React.createElement(DefaultButton, null, "Button 2"))),
    React.createElement("div", { className: 'ms-Row' },
        React.createElement(TextField, { value: 'Tabbable Element 2' })))); };
