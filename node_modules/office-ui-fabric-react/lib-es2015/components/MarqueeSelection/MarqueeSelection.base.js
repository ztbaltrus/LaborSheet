...
import { AutoScroll, BaseComponent, classNamesFunction, customizable, findScrollableParent, getDistanceBetweenPoints, getRTL, createRef } from '../../Utilities';
...
var MarqueeSelectionBase = /** @class */ (function (_super) {
    ...
    MarqueeSelectionBase.prototype.render = function () {
        var _a = this.props, rootProps = _a.rootProps, children = _a.children, theme = _a.theme, className = _a.className, getStyles = _a.getStyles;
    ...
    MarqueeSelectionBase = tslib_1.__decorate([
