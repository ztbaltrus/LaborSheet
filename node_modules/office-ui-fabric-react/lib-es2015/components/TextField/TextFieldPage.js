...
var TextFieldPage = /** @class */ (function (_super) {
    ...
    TextFieldPage.prototype.render = function () {
        return (React.createElement(ComponentPage, { title: 'TextField', componentName: 'TextFieldExample', componentUrl: 'https://github.com/OfficeDev/office-ui-fabric-react/tree/master/packages/office-ui-fabric-react/src/components/TextField', exampleCards: React.createElement("div", null,
                React.createElement(ExampleCard, { title: 'Default TextField with Label', code: TextFieldBasicExampleCode },
                    React.createElement(TextFieldBasicExample, null)),
                React.createElement(ExampleCard, { title: 'TextField with Placeholder', code: TextFieldPlaceholderExampleCode },
                    React.createElement(TextFieldPlaceholderExample, null)),
                React.createElement(ExampleCard, { title: 'Multiline TextField', code: TextFieldMultilineExampleCode },
                    React.createElement(TextFieldMultilineExample, null)),
                React.createElement(ExampleCard, { title: 'Underlined TextField', code: TextFieldUnderlinedExampleCode },
                    React.createElement(TextFieldUnderlinedExample, null)),
                React.createElement(ExampleCard, { title: 'Borderless TextField', code: TextFieldBorderlessExampleCode },
                    React.createElement(TextFieldBorderlessExample, null)),
                React.createElement(ExampleCard, { title: 'TextField with browser AutoComplete', code: TextFieldAutoCompleteExampleCode },
                    React.createElement(TextFieldAutoCompleteExample, null))), implementationExampleCards: React.createElement("div", null,
                React.createElement(ExampleCard, { title: 'Textfield with a prefix', code: TextFieldPrefixExampleCode },
                    React.createElement(TextFieldPrefixExample, null)),
                React.createElement(ExampleCard, { title: 'Textfield with a suffix', code: TextFieldSuffixExampleCode },
                    React.createElement(TextFieldSuffixExample, null)),
                React.createElement(ExampleCard, { title: 'Textfield with a prefix and a suffix', code: TextFieldPrefixAndSuffixExampleCode },
                    React.createElement(TextFieldPrefixAndSuffixExample, null)),
                React.createElement(ExampleCard, { title: 'TextField with an icon', code: TextFieldIconExampleCode },
                    React.createElement(TextFieldIconExample, null)),
                React.createElement(ExampleCard, { title: 'TextField with custom Label', code: TextFieldCustomRenderExampleCode },
                    React.createElement(TextFieldCustomRenderExample, null)),
                React.createElement(ExampleCard, { title: 'TextField with custom description', code: TextFieldOnRenderDescriptionExampleCode },
                    React.createElement(TextFieldOnRenderDescriptionExample, null)),
                React.createElement(ExampleCard, { title: 'TextField error message variations', code: TextFieldErrorMessageExampleCode },
                    React.createElement(TextFieldErrorMessageExample, null))), allowNativeProps: true, nativePropsElement: ['input', 'textarea'], propertiesTables: React.createElement(PropertiesTableSet, { sources: [
                    require('!raw-loader!office-ui-fabric-react/src/components/TextField/TextField.types.ts')
                ] }), overview: React.createElement(PageMarkdown, null, require('!raw-loader!office-ui-fabric-react/src/components/TextField/docs/TextFieldOverview.md')), bestPractices: React.createElement("div", null), dos: React.createElement(PageMarkdown, null, require('!raw-loader!office-ui-fabric-react/src/components/TextField/docs/TextFieldDos.md')), donts: React.createElement(PageMarkdown, null, require('!raw-loader!office-ui-fabric-react/src/components/TextField/docs/TextFieldDonts.md')), isHeaderVisible: this.props.isHeaderVisible, componentStatus: React.createElement(ComponentStatus, tslib_1.__assign({}, TextFieldStatus)) }));
    };
