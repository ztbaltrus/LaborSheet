...
var TextFieldUnderlinedExample = /** @class */ (function (_super) {
    ...
    TextFieldUnderlinedExample.prototype.render = function () {
        return (React.createElement("div", { className: 'docs-TextFieldExample' },
            ...
            React.createElement(TextField, { label: 'Disabled:', underlined: true, disabled: true }),
            React.createElement(TextField, { label: 'Required:', underlined: true, required: true }),
            React.createElement(TextField, { label: 'With error message:', underlined: true, errorMessage: 'Error message' })));
    };
    return TextFieldUnderlinedExample;
}(React.Component));
export { TextFieldUnderlinedExample };
