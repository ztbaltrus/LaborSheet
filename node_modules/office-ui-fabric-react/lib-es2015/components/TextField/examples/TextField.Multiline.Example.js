...
var TextFieldMultilineExample = /** @class */ (function (_super) {
    ...
    TextFieldMultilineExample.prototype.render = function () {
        return (React.createElement("div", { className: 'docs-TextFieldExample' },
            React.createElement(TextField, { label: 'Standard', multiline: true, rows: 4 }),
            React.createElement(TextField, { label: 'Disabled', multiline: true, rows: 4, disabled: true, value: lorem(100) }),
            React.createElement(TextField, { label: 'Required', multiline: true, rows: 4, required: true }),
            React.createElement(TextField, { label: 'With error message', multiline: true, rows: 4, errorMessage: 'This is an error message.' }),
