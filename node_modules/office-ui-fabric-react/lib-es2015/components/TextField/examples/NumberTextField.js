...
var NumberTextField = /** @class */ (function (_super) {
    ...
    NumberTextField.prototype.render = function () {
        return (React.createElement("div", { className: 'NumberTextField' },
            React.createElement(TextField, { className: 'NumberTextField-textField', label: this.props.label, value: this.state.value, onChanged: this._onChanged, onGetErrorMessage: this._validateNumber }),
