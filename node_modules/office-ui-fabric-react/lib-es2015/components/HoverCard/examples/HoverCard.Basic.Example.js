...
var HoverCardBasicExample = /** @class */ (function (_super) {
    ...
    function HoverCardBasicExample(props) {
        ...
        _this._onRenderItemColumn = function (item, index, column) {
            ...
            if (column.key === 'location') {
                return (React.createElement(HoverCard, { id: 'myID1', expandingCardProps: expandingCardProps, instantOpenOnClick: true },
    ...
    HoverCardBasicExample.prototype.render = function () {
        ...
        return (React.createElement("div", null,
            ...
            React.createElement(DetailsList, { setKey: 'hoverSet', items: items, columns: columns, onRenderItemColumn: this._onRenderItemColumn })));
    };
