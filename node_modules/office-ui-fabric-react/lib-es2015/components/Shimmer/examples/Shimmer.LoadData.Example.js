...
var ShimmerLoadDataExample = /** @class */ (function (_super) {
    ...
    ShimmerLoadDataExample.prototype.render = function () {
        ...
        return (React.createElement("div", { className: ShimmerExampleStyles.shimmerExampleContainer },
            React.createElement(Toggle, { checked: isDataLoadedOne, onChanged: this._getContentOne, onText: 'Toggle to show shimmer', offText: 'Toggle to load content' }),
            React.createElement(Shimmer, { isDataLoaded: isDataLoadedOne, ariaLabel: 'Loading content' },
                React.createElement("div", { 
                    ...
                    contentOne,
                    contentOne)),
            React.createElement(Toggle, { checked: isDataLoadedTwo, onChanged: this._getContentTwo, onText: 'Toggle to show shimmer', offText: 'Toggle to load content' }),
