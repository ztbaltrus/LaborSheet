...
var ContextualMenuDirectionalExample = /** @class */ (function (_super) {
    ...
    function ContextualMenuDirectionalExample(props) {
        ...
        _this._onUseRtlHintChange = function (ev, isVisible) {
            _this.setState({
                useDirectionalHintForRtl: isVisible
            });
        };
        _this._onDirectionalChanged = function (option) {
            _this.setState({
                directionalHint: option.key
            });
        };
        _this._onDirectionalRtlChanged = function (option) {
            _this.setState({
    ...
    ContextualMenuDirectionalExample.prototype.render = function () {
        ...
        return (React.createElement("div", { className: 'ms-ContextualMenuDirectionalExample' },
            React.createElement("div", { className: 'ms-ContextualMenuDirectionalExample-configArea' },
                ...
                React.createElement(Dropdown, { label: 'Directional hint', selectedKey: directionalHint, options: DIRECTION_OPTIONS, onChanged: this._onDirectionalChanged }),
                getRTL() &&
                    React.createElement(Checkbox, { label: 'Use RTL directional hint', checked: useDirectionalHintForRtl, onChange: this._onUseRtlHintChange }),
                getRTL() &&
                    React.createElement(Dropdown, { label: 'Directional hint for RTL', selectedKey: directionalHintForRTL, options: DIRECTION_OPTIONS, onChanged: this._onDirectionalRtlChanged, disabled: !useDirectionalHintForRtl })),
