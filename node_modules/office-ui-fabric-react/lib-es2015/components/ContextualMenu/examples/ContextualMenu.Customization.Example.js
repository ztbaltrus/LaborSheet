...
var ContextualMenuCustomizationExample = /** @class */ (function (_super) {
    ...
    function ContextualMenuCustomizationExample() {
        ...
        _this._renderCharmMenuItem = function (item, dismissMenu) {
            return (React.createElement(IconButton, { iconProps: { iconName: item.name }, className: 'ms-ContextualMenu-customizationExample-icon ms-ContextualMenu-link', "data-is-focusable": true, onClick: dismissMenu }));
        };
        return _this;
    }
    ...
    ContextualMenuCustomizationExample.prototype._renderCategoriesList = function (item) {
        return (React.createElement("ul", { className: 'ms-ContextualMenu-customizationExample-categoriesList' },
            React.createElement("li", { className: 'ms-ContextualMenu-item' }, item.categoryList.map(function (category) {
                return React.createElement(DefaultButton, { className: 'ms-ContextualMenu-link ms-ContextualMenu-customizationExample-button', role: 'menuitem', key: category.name },
...
export { ContextualMenuCustomizationExample };
