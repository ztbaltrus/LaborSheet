...
var SpinButtonCustomStyledExample = /** @class */ (function (_super) {
    ...
    SpinButtonCustomStyledExample.prototype.render = function () {
        return (React.createElement("div", null,
            React.createElement(SpinButton, { styles: styles, upArrowButtonStyles: upArrowButtonStyles, downArrowButtonStyles: downArrowButtonStyles, defaultValue: '0', label: 'Custom styled SpinButton:', min: 0, max: 100, step: 1 })));
    };
