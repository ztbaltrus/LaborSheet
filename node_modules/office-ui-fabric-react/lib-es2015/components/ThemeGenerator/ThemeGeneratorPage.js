...
var ThemeGeneratorPage = /** @class */ (function (_super) {
    ...
    ThemeGeneratorPage.prototype.render = function () {
        ...
        var fabricThemeSlots = [this._fabricSlotWidget(FabricSlots.themeDarker),
        ...
        var fabricNeutralForegroundSlots = [this._fabricSlotWidget(FabricSlots.black),
        ...
        var fabricNeutralBackgroundSlots = [this._fabricSlotWidget(FabricSlots.neutralTertiaryAlt),
        ...
        return (React.createElement("div", { className: 'ms-themer' },
            ...
            colorPickerVisible && colorPickerSlotRule !== null && colorPickerSlotRule !== undefined && colorPickerElement &&
                React.createElement(Callout, { key: colorPickerSlotRule.name, gapSpace: 10, target: colorPickerElement, setInitialFocus: true, onDismiss: this._colorPickerOnDismiss },
            ...
            React.createElement("div", { style: { display: 'flex' } }, [this._baseColorSlotPicker(BaseSlots.primaryColor, 'Primary theme color'),
            ...
            React.createElement("table", { className: 'ms-themer-accessibilityTable' },
                ...
                React.createElement("tbody", null, [this._accessibilityRow(FabricSlots.neutralPrimary, FabricSlots.white)]))));
    };
