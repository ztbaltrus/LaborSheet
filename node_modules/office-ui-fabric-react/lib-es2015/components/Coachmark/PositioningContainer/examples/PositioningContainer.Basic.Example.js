    ...
    PositioningContainerBasicExample.prototype.render = function () {
        ...
        return (React.createElement("div", null,
            React.createElement("div", { className: 'ms-PositioningContainerBasicExample-buttonArea' },
                React.createElement(DefaultButton, { onClick: this._onShowMenuClicked, text: isPositioningContainerVisible ? 'Hide Positioning Container' : 'Show Positioning Container', className: 'ms-PositioningContainer-basicExampleButton' })),
            isPositioningContainerVisible && (React.createElement(PositioningContainer, { className: 'ms-PositioningContainer', role: 'alertdialog', target: '.ms-PositioningContainer-basicExampleButton', onDismiss: this._onDismiss, setInitialFocus: true },
...
export { PositioningContainerBasicExample };
