...
var OverflowSetCustomExample = /** @class */ (function (_super) {
        ...
        return (React.createElement(OverflowSet, { items: [
                {
                    ...
                    onRender: function (item) {
                        return (React.createElement(SearchBox, { placeholder: 'Search' }));
                    }
                },
                {
                    key: 'newItem',
    ...
    OverflowSetCustomExample.prototype._onRenderItem = function (item) {
        if (item.onRender) {
            return (item.onRender(item));
        }
        return (React.createElement(DefaultButton, { iconProps: { iconName: item.icon }, menuProps: item.subMenuProps, text: item.name }));
    };
    OverflowSetCustomExample.prototype._onRenderOverflowButton = function (overflowItems) {
        return (React.createElement(DefaultButton, { className: css(styles.overflowButton), menuIconProps: { iconName: 'More' }, menuProps: { items: overflowItems } }));
    };
