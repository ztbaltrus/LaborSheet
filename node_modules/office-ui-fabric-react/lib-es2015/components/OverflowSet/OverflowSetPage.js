...
var OverflowSetPage = /** @class */ (function (_super) {
    ...
    OverflowSetPage.prototype.render = function () {
        return (React.createElement(ComponentPage, { title: 'OverflowSet', componentName: 'OverflowSetExample', componentUrl: 'https://github.com/OfficeDev/office-ui-fabric-react/tree/master/packages/office-ui-fabric-react/src/components/OverflowSet', overview: React.createElement(PageMarkdown, null, require('!raw-loader!office-ui-fabric-react/src/components/OverflowSet/docs/OverflowSetOverview.md')), allowNativeProps: true, exampleCards: React.createElement(LayerHost, null,
