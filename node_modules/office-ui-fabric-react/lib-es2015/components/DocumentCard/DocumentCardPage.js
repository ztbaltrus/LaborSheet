...
var DocumentCardPage = /** @class */ (function (_super) {
    ...
    DocumentCardPage.prototype.render = function () {
        return (React.createElement(ComponentPage, { title: 'DocumentCard', componentName: 'DocumentCardExample', componentUrl: 'https://github.com/OfficeDev/office-ui-fabric-react/tree/master/packages/office-ui-fabric-react/src/components/', exampleCards: React.createElement("div", null,
                React.createElement(ExampleCard, { title: 'Default DocumentCard', code: DocumentCardBasicExampleCode },
                ...
                React.createElement(ExampleCard, { title: 'DocumentCard with multiple items, commands, and views', code: DocumentCardCompleteExampleCode },
                ...
                React.createElement(ExampleCard, { title: 'DocumentCard with compact layout ', code: DocumentCardCompactExampleCode },
                    ...
                    React.createElement(DocumentCardCompactExample, null))), propertiesTables: React.createElement(PropertiesTableSet, { sources: [
                    require('!raw-loader!office-ui-fabric-react/src/components/DocumentCard/DocumentCard.types.ts')
                ] }), overview: React.createElement(PageMarkdown, null, require('!raw-loader!office-ui-fabric-react/src/components/DocumentCard/docs/DocumentCardOverview.md')), bestPractices: React.createElement("div", null), dos: React.createElement(PageMarkdown, null, require('!raw-loader!office-ui-fabric-react/src/components/DocumentCard/docs/DocumentCardDos.md')), donts: React.createElement(PageMarkdown, null, require('!raw-loader!office-ui-fabric-react/src/components/DocumentCard/docs/DocumentCardDonts.md')), isHeaderVisible: this.props.isHeaderVisible, componentStatus: React.createElement(ComponentStatus, tslib_1.__assign({}, DocumentCardStatus)) }));
    };
