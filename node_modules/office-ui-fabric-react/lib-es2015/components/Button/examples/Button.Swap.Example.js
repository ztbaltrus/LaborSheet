...
var ButtonSwapExample = /** @class */ (function (_super) {
    ...
    ButtonSwapExample.prototype.render = function () {
        ...
        var button = isPrimary
            ? (React.createElement(PrimaryButton, { ref: this._setButtonRef, disabled: disabled, checked: checked, onClick: this._onClick }, text)) : (React.createElement(DefaultButton, { ref: this._setButtonRef, disabled: disabled, checked: checked, onClick: this._onClick }, text));
