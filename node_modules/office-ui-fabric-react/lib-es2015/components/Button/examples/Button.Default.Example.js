    ...
    ButtonDefaultExample.prototype.render = function () {
        ...
        return (React.createElement("div", { className: css(classNames.twoup) },
            React.createElement("div", null,
                ...
                React.createElement(DefaultButton, { "data-automation-id": 'test', disabled: disabled, checked: checked, text: 'Button' })),
            React.createElement("div", null,
                React.createElement(Label, null, "Primary"),
                React.createElement(DefaultButton, { primary: true, "data-automation-id": 'test', disabled: disabled, checked: checked, text: 'Button', onClick: this._alertClicked }))));
    };
