    ...
    ButtonCommandBarExample.prototype.render = function () {
        ...
        return (React.createElement("div", null,
            React.createElement("div", { style: { display: 'flex', alignItems: 'stretch', height: '40px' } },
                ...
                React.createElement(CommandBarButton, { "data-automation-id": 'test', disabled: disabled, checked: checked, iconProps: { iconName: 'Add' }, text: 'Create account', split: true, onClick: alertClicked, menuProps: {
                        items: [
                            {
                                key: 'emailMessage',
                                name: 'Email message',
