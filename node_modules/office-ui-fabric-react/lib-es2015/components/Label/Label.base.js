...
var Label = /** @class */ (function (_super) {
    ...
    Label.prototype.render = function () {
        ...
        return (React.createElement("label", tslib_1.__assign({}, getNativeProps(this.props, divProperties), { className: getLabelClassNames(theme, className, !!disabled, !!required).root }), children));
    };
