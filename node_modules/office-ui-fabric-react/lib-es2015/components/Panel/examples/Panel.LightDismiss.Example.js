...
var PanelLightDismissExample = /** @class */ (function (_super) {
    ...
    function PanelLightDismissExample(props) {
    ...
    PanelLightDismissExample.prototype.render = function () {
        return (React.createElement("div", null,
            ...
            React.createElement(Panel, { isOpen: this.state.showPanel, isLightDismiss: true, headerText: 'Light Dismiss Panel', onDismiss: this._hidePanel },
...
export { PanelLightDismissExample };
