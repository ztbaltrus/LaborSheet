...
var PanelHiddenOnDismissExample = /** @class */ (function (_super) {
    ...
    function PanelHiddenOnDismissExample(props) {
    ...
    PanelHiddenOnDismissExample.prototype.render = function () {
        return (React.createElement("div", null,
            ...
            React.createElement(Panel, { isOpen: this.state.showPanel, isHiddenOnDismiss: true, headerText: 'Hidden on Dismiss Panel', onDismiss: this._hidePanel },
...
export { PanelHiddenOnDismissExample };
