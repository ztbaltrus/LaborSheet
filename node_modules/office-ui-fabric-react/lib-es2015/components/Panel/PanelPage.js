...
var PanelPage = /** @class */ (function (_super) {
    ...
    PanelPage.prototype.render = function () {
        return (React.createElement(ComponentPage, { title: 'Panel', componentName: 'PanelExample', componentUrl: 'https://github.com/OfficeDev/office-ui-fabric-react/tree/master/packages/office-ui-fabric-react/src/components/Panel', allowNativeProps: true, exampleCards: React.createElement("div", null,
                ...
                ] }), overview: React.createElement(PageMarkdown, null, require('!raw-loader!office-ui-fabric-react/src/components/Panel/docs/PanelOverview.md')), bestPractices: React.createElement("div", null), dos: React.createElement(PageMarkdown, null, require('!raw-loader!office-ui-fabric-react/src/components/Panel/docs/PanelDos.md')), donts: React.createElement(PageMarkdown, null, require('!raw-loader!office-ui-fabric-react/src/components/Panel/docs/PanelDonts.md')), isHeaderVisible: this.props.isHeaderVisible, componentStatus: React.createElement(ComponentStatus, tslib_1.__assign({}, PanelStatus)) }));
    };
    return PanelPage;
}(React.Component));
export { PanelPage };
