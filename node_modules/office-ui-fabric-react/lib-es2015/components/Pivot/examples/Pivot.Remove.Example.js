...
var PivotRemoveExample = /** @class */ (function (_super) {
    ...
    PivotRemoveExample.prototype.render = function () {
        ...
        if (this.state.shouldShowFirstPivotItem) {
            pivotArray.push(React.createElement(PivotItem, { linkText: 'Foo', itemKey: 'Foo', key: 'Foo' },
        ...
        pivotArray = pivotArray.concat((React.createElement(PivotItem, { linkText: 'Bar', itemKey: 'Bar', key: 'Bar' },
            React.createElement(Label, null, "Pivot #2"))), (React.createElement(PivotItem, { linkText: 'Bas', itemKey: 'Bas', key: 'Bas' },
            React.createElement(Label, null, "Pivot #3"))), (React.createElement(PivotItem, { linkText: 'Biz', itemKey: 'Biz', key: 'Biz' },
        ...
        return (React.createElement("div", null,
            ...
            React.createElement("div", null,
                React.createElement(DefaultButton, { onClick: this._handleClick, text: (this.state.shouldShowFirstPivotItem ? 'Hide' : 'Show') + " First Pivot Item" }))));
    };
