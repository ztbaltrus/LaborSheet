...
var PivotFabricExample = /** @class */ (function (_super) {
    ...
    PivotFabricExample.prototype.render = function () {
        return (React.createElement("div", null,
            React.createElement(Pivot, { linkFormat: PivotLinkFormat.links, linkSize: PivotLinkSize.normal },
                React.createElement(PivotItem, { linkText: 'Callout' },
                    React.createElement(Label, null, "Callout Example"),
                    React.createElement(CalloutBasicExample, null)),
                React.createElement(PivotItem, { linkText: 'Spinner' },
                    React.createElement(Label, null, "Spinner Example"),
                    React.createElement(SpinnerBasicExample, null)),
                React.createElement(PivotItem, { linkText: 'Persona' },
                    React.createElement(Label, null, "Persona Example"),
                    React.createElement(PersonaBasicExample, null)))));
    };
    return PivotFabricExample;
}(React.Component));
export { PivotFabricExample };
