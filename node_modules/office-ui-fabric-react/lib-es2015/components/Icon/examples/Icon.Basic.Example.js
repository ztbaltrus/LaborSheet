...
var IconBasicExample = /** @class */ (function (_super) {
    ...
    IconBasicExample.prototype.render = function () {
        return (React.createElement("div", null,
            React.createElement(Icon, { iconName: 'CompassNW', className: 'ms-IconExample' }),
            React.createElement(Icon, { iconName: 'Dictionary', className: 'ms-IconExample' }),
            React.createElement(Icon, { iconName: 'TrainSolid', className: 'ms-IconExample' })));
    };
    return IconBasicExample;
}(React.Component));
export { IconBasicExample };
