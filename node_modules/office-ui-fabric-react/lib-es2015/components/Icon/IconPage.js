...
var IconPage = /** @class */ (function (_super) {
    ...
    IconPage.prototype.render = function () {
        return (React.createElement(ComponentPage, { title: 'Icon', componentName: 'IconExample', componentUrl: 'https://github.com/OfficeDev/office-ui-fabric-react/tree/master/packages/office-ui-fabric-react/src/components/Icon', exampleCards: React.createElement("div", null,
                ...
                React.createElement(ExampleCard, { title: 'Icon using image sheet', code: IconImageSheetExampleCode },
                    React.createElement(IconImageSheetExample, null))), allowNativeProps: true, propertiesTables: React.createElement(PropertiesTableSet, { sources: [
                    require('!raw-loader!office-ui-fabric-react/src/components/Icon/Icon.types.ts')
                ] }), overview: React.createElement(PageMarkdown, null, require('!raw-loader!office-ui-fabric-react/src/components/Icon/docs/IconOverview.md')), bestPractices: React.createElement("div", null), dos: React.createElement(PageMarkdown, null, require('!raw-loader!office-ui-fabric-react/src/components/Icon/docs/IconDos.md')), donts: React.createElement(PageMarkdown, null, require('!raw-loader!office-ui-fabric-react/src/components/Icon/docs/IconDonts.md')), isHeaderVisible: this.props.isHeaderVisible, componentStatus: React.createElement(ComponentStatus, tslib_1.__assign({}, IconStatus)) }));
    };
    return IconPage;
}(React.Component));
export { IconPage };
