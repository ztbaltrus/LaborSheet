...
var ListPage = /** @class */ (function (_super) {
    ...
    ListPage.prototype.render = function () {
        return (React.createElement(ComponentPage, { title: 'List', componentName: 'ListExample', componentUrl: 'https://github.com/OfficeDev/office-ui-fabric-react/tree/master/packages/office-ui-fabric-react/src/components/List', exampleCards: React.createElement("div", null,
                ...
                React.createElement(ExampleCard, { title: 'Rendering ghost items while the list is scrolling', isOptIn: true, code: ListGhostingExampleCode },
                    React.createElement(ListGhostingExample, { items: _cachedItems }))), allowNativeProps: true, propertiesTables: React.createElement(PropertiesTableSet, { sources: [
                    require('!raw-loader!office-ui-fabric-react/src/components/List/List.types.ts')
                ] }), overview: React.createElement(PageMarkdown, null, require('!raw-loader!office-ui-fabric-react/src/components/List/docs/ListOverview.md')), isHeaderVisible: this.props.isHeaderVisible, componentStatus: React.createElement(ComponentStatus, tslib_1.__assign({}, ListStatus)) }));
    };
    return ListPage;
}(React.Component));
export { ListPage };
