...
var ColorPickerPage = /** @class */ (function (_super) {
    ...
    ColorPickerPage.prototype.render = function () {
        return (React.createElement(ComponentPage, { title: 'ColorPicker', componentName: 'ColorPickerExample', componentUrl: 'https://github.com/OfficeDev/office-ui-fabric-react/tree/master/packages/office-ui-fabric-react/src/components/ColorPicker', exampleCards: React.createElement(ExampleCard, { title: 'Default ColorPicker', code: ColorPickerBasicExampleCode },
                ...
                ] }), overview: React.createElement(PageMarkdown, null, require('!raw-loader!office-ui-fabric-react/src/components/ColorPicker/docs/ColorPickerOverview.md')), isHeaderVisible: this.props.isHeaderVisible, componentStatus: React.createElement(ComponentStatus, tslib_1.__assign({}, ColorPickerStatus)) }));
    };
