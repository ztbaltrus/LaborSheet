...
var ColorRectangle = /** @class */ (function (_super) {
    ...
    ColorRectangle.prototype.render = function () {
        ...
        return (React.createElement("div", { ref: this._root, className: css('ms-ColorPicker-colorRect', styles.colorRect), style: { minWidth: minSize, minHeight: minSize, backgroundColor: fullColorString }, onMouseDown: this._onMouseDown },
