...
var FocusTrapComponent = /** @class */ (function (_super) {
    ...
    FocusTrapComponent.prototype.render = function () {
        var contents = (React.createElement("div", { className: 'ms-FocusTrapComponent' },
            React.createElement(DefaultButton, { onClick: this._onStringButtonClicked, text: this.props.name }),
            React.createElement(Toggle, { defaultChecked: this.props.isActive, onChanged: this._onFocusTrapZoneToggleChanged, label: 'Focus Trap Zone', onText: 'On', offText: 'Off' }),
            this.props.children));
        if (this.props.isActive) {
            return (React.createElement(FocusTrapZone, { forceFocusInsideTrap: false }, contents));
        }
        return contents;
    };
...
var FocusTrapZoneNestedExample = /** @class */ (function (_super) {
    ...
    FocusTrapZoneNestedExample.prototype.render = function () {
        ...
        return (React.createElement("div", null,
            ...
            React.createElement(DefaultButton, { onClick: this._randomize }, "Randomize")));
    };
