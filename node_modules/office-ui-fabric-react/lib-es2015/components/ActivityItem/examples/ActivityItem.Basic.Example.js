        ...
        var activityItemExamples = [
            {
                key: 1,
                activityDescription: [
                    React.createElement(Link, { key: 1, className: css(classNames.nameText), onClick: function () { alert('A name was clicked.'); } }, "Philippe Lampros"),
                ...
                comments: [
                    ...
                    React.createElement(Link, { key: 2, className: css(classNames.nameText), onClick: function () { alert('An @mentioned name was clicked.'); } }, "@An\u0111ela Debeljak"),
            ...
            },
            {
                key: 2,
                activityDescription: [
                    React.createElement(Link, { key: 1, className: css(classNames.nameText), onClick: function () { alert('A name was clicked.'); } }, "Lisha Refai"),
            ...
            },
            {
                key: 3,
                activityDescription: [
                    React.createElement(Link, { key: 1, className: css(classNames.nameText), onClick: function () { alert('A name was clicked.'); } }, "Julian Arvidsson"),
                    React.createElement("span", { key: 2 }, " moved "),
                    React.createElement(Link, { key: 3, className: css(classNames.nameText), onClick: function () { alert('A document was clicked.'); } }, "PresentationTitle.pptx"),
                    React.createElement("span", { key: 4 }, " to "),
                    React.createElement(Link, { key: 5, className: css(classNames.nameText), onClick: function () { alert('A folder was clicked.'); } }, "Destination Folder")
                ],
