...
var DetailsListBasicExample = /** @class */ (function (_super) {
    ...
    DetailsListBasicExample.prototype.render = function () {
        ...
        return (React.createElement("div", null,
            ...
            React.createElement(MarqueeSelection, { selection: this._selection },
                React.createElement(DetailsList, { items: items, columns: _columns, setKey: 'set', layoutMode: DetailsListLayoutMode.fixedColumns, selection: this._selection, selectionPreservedOnEmptyClick: true, ariaLabelForSelectionColumn: 'Toggle selection', ariaLabelForSelectAllCheckbox: 'Toggle selection for all items', onItemInvoked: this._onItemInvoked }))));
    };
    ...
    DetailsListBasicExample.prototype._onItemInvoked = function (item) {
