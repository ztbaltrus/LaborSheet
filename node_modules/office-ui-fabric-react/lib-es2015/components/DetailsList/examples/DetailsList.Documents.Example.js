...
var DetailsListDocumentsExample = /** @class */ (function (_super) {
    ...
    DetailsListDocumentsExample.prototype.render = function () {
        ...
        return (React.createElement("div", null,
            ...
            React.createElement(Toggle, { label: 'Enable Modal Selection', checked: this.state.isModalSelection, onChanged: this._onChangeModalSelection, onText: 'Modal', offText: 'Normal' }),
            React.createElement("div", null, selectionDetails),
            React.createElement(TextField, { label: 'Filter by name:', onChanged: this._onChangeText }),
