...
var DetailsListDragDropExample = /** @class */ (function (_super) {
    ...
    DetailsListDragDropExample.prototype.render = function () {
        ...
        return (React.createElement("div", { className: 'detailsListDragDropExample' },
            React.createElement(Toggle, { label: 'Enable Column Reorder', checked: isColumnReorderEnabled, onChanged: this._onChangeColumnReorderEnabled, onText: 'Enabled', offText: 'Disabled' }),
            React.createElement(TextField, { label: 'Number of Left frozen columns:', onGetErrorMessage: this._validateNumber, value: frozenColumnCountFromStart, onChanged: this._onChangeStartCountText }),
            React.createElement(TextField, { label: 'Number of Right frozen columns:', onGetErrorMessage: this._validateNumber, value: frozenColumnCountFromEnd, onChanged: this._onChangeEndCountText }),
