...
var ImageCenterExample = /** @class */ (function (_super) {
    ...
    ImageCenterExample.prototype.render = function () {
        ...
        return (React.createElement("div", null,
            ...
            React.createElement(Image, tslib_1.__assign({}, imageProps, { src: 'http://placehold.it/800x300', alt: 'Example implementation of the property image fit using the center value on an image larger than the frame.' })),
            ...
            React.createElement(Image, tslib_1.__assign({}, imageProps, { src: 'http://placehold.it/100x100', alt: 'Example implementation of the property image fit using the center value on an image smaller than the frame.' }))));
    };
