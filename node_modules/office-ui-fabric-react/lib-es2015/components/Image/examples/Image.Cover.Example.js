...
var ImageCoverExample = /** @class */ (function (_super) {
    ...
    ImageCoverExample.prototype.render = function () {
        ...
        return (React.createElement("div", null,
            ...
            React.createElement(Image, tslib_1.__assign({}, imageProps, { alt: 'Example implementation of the property image fit using the cover value on an image wider than the frame.', width: 150, height: 250 })),
            ...
            React.createElement(Image, tslib_1.__assign({}, imageProps, { alt: 'Example implementation of the property image fit using the cover value on an image taller than the frame.', width: 250, height: 150 }))));
    };
