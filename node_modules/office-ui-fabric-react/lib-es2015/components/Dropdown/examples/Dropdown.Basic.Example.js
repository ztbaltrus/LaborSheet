...
var DropdownBasicExample = /** @class */ (function (_super) {
    ...
    function DropdownBasicExample(props) {
        ...
        _this._basicDropdown = createRef();
    ...
    DropdownBasicExample.prototype.render = function () {
        ...
        return (React.createElement("div", { className: 'docs-DropdownExample' },
            React.createElement(Dropdown, { placeHolder: 'Select an Option', label: 'Basic uncontrolled example:', id: 'Basicdrop1', ariaLabel: 'Basic dropdown example', options: [
            ...
            React.createElement(Dropdown, { label: 'Controlled example:', selectedKey: (selectedItem ? selectedItem.key : undefined), onChanged: this.changeState, onFocus: this._log('onFocus called'), onBlur: this._log('onBlur called'), placeHolder: 'Select an Option', options: [
                    { key: 'A', text: 'Option a' },
                    { key: 'B', text: 'Option b' },
                    { key: 'C', text: 'Option c' },
                    { key: 'D', text: 'Option d' },
            ...
            React.createElement(Dropdown, { placeHolder: 'Select options', label: 'Multi-Select controlled example:', selectedKeys: selectedItems, onChanged: this.onChangeMultiSelect, onFocus: this._log('onFocus called'), onBlur: this._log('onBlur called'), multiSelect: true, options: [
