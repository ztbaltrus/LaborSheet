...
var ComboBoxCustomStyledExample = /** @class */ (function (_super) {
    ...
    ComboBoxCustomStyledExample.prototype.render = function () {
        return (React.createElement("div", { className: 'ms-ComboBoxCustomStyledExample' },
            React.createElement(ComboBox, { defaultSelectedKey: 'C', label: 'Custom styled uncontrolled ComboBox (allowFreeform: T, AutoComplete: T):', id: 'Basicdrop6', ariaLabel: 'Custom styled ComboBox example', allowFreeform: true, autoComplete: 'on', options: this._testOptionsWithCustomStyling, styles: {
                    container: {
                        maxWidth: '300px'
                    },
